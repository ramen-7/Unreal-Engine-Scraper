<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/hardware-and-software-requirements-for-container-deployments-in-unreal-engine?application_version=5.7 -->
...
Hardware and software requirements for building and running Unreal Engine containers.

![Hardware and Software Requirements](https://dev.epicgames.com/community/api/documentation/image/ad2165ef-3be2-46d9-acbd-b2c5e3c2d2c0?resizing_type=fill&width=1920&height=335)
...
* [Requirements for Linux Containers](/documentation/en-us/unreal-engine/hardware-and-software-requirements-for-container-deployments-in-unreal-engine?application_version=5.7#requirementsforlinuxcontainers)
* [Requirements for Windows Containers](/documentation/en-us/unreal-engine/hardware-and-software-requirements-for-container-deployments-in-unreal-engine?application_version=5.7#requirementsforwindowscontainers)
* [Installing Docker](/documentation/en-us/unreal-engine/hardware-and-software-requirements-for-container-deployments-in-unreal-engine?application_version=5.7#installingdocker)
