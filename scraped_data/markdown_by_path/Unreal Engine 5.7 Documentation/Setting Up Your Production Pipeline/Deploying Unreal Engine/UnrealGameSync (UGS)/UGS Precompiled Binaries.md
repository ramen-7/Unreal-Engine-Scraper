<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/using-precompiled-binaries-in-unreal-game-sync-for-unreal-engine?application_version=5.7 -->
...
8. UGS Precompiled Binaries

# UGS Precompiled Binaries

How to use precompiled binaries to optimize development for your project

![UGS Precompiled Binaries](https://dev.epicgames.com/community/api/documentation/image/94cfb273-2b67-4fef-88e8-43e8a2a9fd9a?resizing_type=fill&width=1920&height=335)
...
* [Basic Perforce Setup](/documentation/en-us/unreal-engine/using-precompiled-binaries-in-unreal-game-sync-for-unreal-engine?application_version=5.7#basicperforcesetup)
* [Setting Up Streams](/documentation/en-us/unreal-engine/using-precompiled-binaries-in-unreal-game-sync-for-unreal-engine?application_version=5.7#settingupstreams)
* [Generating and Uploading Precompiled Binaries](/documentation/en-us/unreal-engine/using-precompiled-binaries-in-unreal-game-sync-for-unreal-engine?application_version=5.7#generatinganduploadingprecompiledbinaries)
* [Using Precompiled Binaries from UGS](/documentation/en-us/unreal-engine/using-precompiled-binaries-in-unreal-game-sync-for-unreal-engine?application_version=5.7#usingprecompiledbinariesfromugs)
* [Using Branches](/documentation/en-us/unreal-engine/using-precompiled-binaries-in-unreal-game-sync-for-unreal-engine?application_version=5.7#usingbranches)
