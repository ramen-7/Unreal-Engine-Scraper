<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/unreal-engine-build-tool-target-reference?application_version=5.7 -->
...
![Targets](https://dev.epicgames.com/community/api/documentation/image/304c887d-348c-442f-8789-082d4b9a9cef?resizing_type=fill&width=1920&height=335)
...
* [Read-Only Properties](/documentation/en-us/unreal-engine/unreal-engine-build-tool-target-reference?application_version=5.7#read-onlyproperties)
* [Read/Write Properties](/documentation/en-us/unreal-engine/unreal-engine-build-tool-target-reference?application_version=5.7#read/writeproperties)
