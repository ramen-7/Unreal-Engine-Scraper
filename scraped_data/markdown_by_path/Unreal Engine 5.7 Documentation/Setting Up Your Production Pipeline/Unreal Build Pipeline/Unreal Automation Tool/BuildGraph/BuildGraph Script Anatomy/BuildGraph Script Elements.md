<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/buildgraph-script-elements-reference-for-unreal-engine?application_version=5.7 -->
...
10. BuildGraph Script Elements

# BuildGraph Script Elements

Learn about BuildGraph Elements.

![BuildGraph Script Elements](https://dev.epicgames.com/community/api/documentation/image/91912449-cd71-4f99-b1ab-2d023cd2cf21?resizing_type=fill&width=1920&height=335)
...
* [Elements](/documentation/en-us/unreal-engine/buildgraph-script-elements-reference-for-unreal-engine?application_version=5.7#elements)
* [Graph Structure](/documentation/en-us/unreal-engine/buildgraph-script-elements-reference-for-unreal-engine?application_version=5.7#graphstructure)
* [Node](/documentation/en-us/unreal-engine/buildgraph-script-elements-reference-for-unreal-engine?application_version=5.7#node)
* [Aggregate](/documentation/en-us/unreal-engine/buildgraph-script-elements-reference-for-unreal-engine?application_version=5.7#aggregate)
* [Agent](/documentation/en-us/unreal-engine/buildgraph-script-elements-reference-for-unreal-engine?application_version=5.7#agent)
* [Trigger](/documentation/en-us/unreal-engine/buildgraph-script-elements-reference-for-unreal-engine?application_version=5.7#trigger)
* [Property Manipulation](/documentation/en-us/unreal-engine/buildgraph-script-elements-reference-for-unreal-engine?application_version=5.7#propertymanipulation)
* [Property](/documentation/en-us/unreal-engine/buildgraph-script-elements-reference-for-unreal-engine?application_version=5.7#property)
* [Option](/documentation/en-us/unreal-engine/buildgraph-script-elements-reference-for-unreal-engine?application_version=5.7#option)
* [EnvVar](/documentation/en-us/unreal-engine/buildgraph-script-elements-reference-for-unreal-engine?application_version=5.7#envvar)
* [Flow Control](/documentation/en-us/unreal-engine/buildgraph-script-elements-reference-for-unreal-engine?application_version=5.7#flowcontrol)
* [Include](/documentation/en-us/unreal-engine/buildgraph-script-elements-reference-for-unreal-engine?application_version=5.7#include)
* [Do](/documentation/en-us/unreal-engine/buildgraph-script-elements-reference-for-unreal-engine?application_version=5.7#do)
* [Switch](/documentation/en-us/unreal-engine/buildgraph-script-elements-reference-for-unreal-engine?application_version=5.7#switch)
* [ForEach](/documentation/en-us/unreal-engine/buildgraph-script-elements-reference-for-unreal-engine?application_version=5.7#foreach)
* [Diagnostics](/documentation/en-us/unreal-engine/buildgraph-script-elements-reference-for-unreal-engine?application_version=5.7#diagnostics)
* [Warning](/documentation/en-us/unreal-engine/buildgraph-script-elements-reference-for-unreal-engine?application_version=5.7#warning)
* [Error](/documentation/en-us/unreal-engine/buildgraph-script-elements-reference-for-unreal-engine?application_version=5.7#error)
