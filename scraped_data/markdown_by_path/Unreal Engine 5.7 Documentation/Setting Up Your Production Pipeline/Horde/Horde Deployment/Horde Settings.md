<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7 -->
...
A reference for Horde deployment settings.

![Horde Settings](https://dev.epicgames.com/community/api/documentation/image/0f841fbf-383c-45d9-9bff-0096ebcb1228?resizing_type=fill&width=1920&height=335)
...
| Name | Description |
| --- | --- |
| `runModes` | [RunMode](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine#runmode-enum)`[]` Modes that the server should run in. Runmodes can be used in a multi-server deployment to limit the operations that a particular instance will try to perform. |
...
| `authMethod` | [AuthMethod](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine#authmethod-enum) Type of authentication (e.g anonymous, OIDC, built-in Horde accounts) If "Horde" auth mode is used, be sure to configure "ServerUrl" as well. |
...
* [Server Settings](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#serversettings)
* [Server.json](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#serverjson)
* [RunMode (Enum)](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#runmode(enum))
* [AuthMethod (Enum)](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#authmethod(enum))
* [FeatureFlagSettings](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#featureflagsettings)
* [OpenTelemetrySettings](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#opentelemetrysettings)
* [OpenTelemetryProtocolExporterSettings](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#opentelemetryprotocolexportersettings)
* [ServerPluginsConfig](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#serverpluginsconfig)
* [ComputeServerConfig](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#computeserverconfig)
* [FleetManagerType (Enum)](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#fleetmanagertype(enum))
* [PoolSizeStrategy (Enum)](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#poolsizestrategy(enum))
* [PluginServerConfig](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#pluginserverconfig)
* [AnalyticsServerConfig](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#analyticsserverconfig)
* [TelemetrySinkConfig](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#telemetrysinkconfig)
* [EpicTelemetryConfig](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#epictelemetryconfig)
* [MongoTelemetryConfig](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#mongotelemetryconfig)
* [BuildServerConfig](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#buildserverconfig)
* [PerforceConnectionSettings](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#perforceconnectionsettings)
* [PerforceCredentials](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#perforcecredentials)
* [CommitSettings](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#commitsettings)
* [BundleOptions](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#bundleoptions)
* [BundleVersion (Enum)](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#bundleversion(enum))
* [BundleCompressionFormat (Enum)](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#bundlecompressionformat(enum))
* [ChunkingOptions](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#chunkingoptions)
* [LeafChunkedDataNodeOptions](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#leafchunkeddatanodeoptions)
* [InteriorChunkedDataNodeOptions](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#interiorchunkeddatanodeoptions)
* [StorageServerConfig](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#storageserverconfig)
* [BackendConfig](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#backendconfig)
* [StorageBackendType (Enum)](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#storagebackendtype(enum))
* [AwsCredentialsType (Enum)](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#awscredentialstype(enum))
* [ToolsServerConfig](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#toolsserverconfig)
* [BundledToolConfig](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#bundledtoolconfig)
* [AclConfig](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#aclconfig)
* [AclEntryConfig](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#aclentryconfig)
* [AclClaimConfig](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#aclclaimconfig)
* [AclProfileConfig](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#aclprofileconfig)
* [Agent Settings](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#agentsettings)
* [Agent.json (Agent)](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#agentjson(agent))
* [ServerProfile](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#serverprofile)
* [DirectoryReference](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#directoryreference)
* [MountNetworkShare](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#mountnetworkshare)
* [OpenTelemetrySettings](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#opentelemetrysettings-2)
* [OpenTelemetryProtocolExporterSettings](/documentation/en-us/unreal-engine/horde-settings-for-unreal-engine?application_version=5.7#opentelemetryprotocolexportersettings-2)
