<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/horde-storage-for-unreal-engine?application_version=5.7 -->
...
An overview of Horde storage for use with Unreal Engine.

![Horde Storage](https://dev.epicgames.com/community/api/documentation/image/3d5aa0ad-32a6-44ce-9fef-91ea1c2e219e?resizing_type=fill&width=1920&height=335)
...
* [History](/documentation/en-us/unreal-engine/horde-storage-for-unreal-engine?application_version=5.7#history)
* [Blobs](/documentation/en-us/unreal-engine/horde-storage-for-unreal-engine?application_version=5.7#blobs)
* [Refs and Aliases](/documentation/en-us/unreal-engine/horde-storage-for-unreal-engine?application_version=5.7#refsandaliases)
* [Content Addressing](/documentation/en-us/unreal-engine/horde-storage-for-unreal-engine?application_version=5.7#contentaddressing)
* [Implementation](/documentation/en-us/unreal-engine/horde-storage-for-unreal-engine?application_version=5.7#implementation)
* [Layers](/documentation/en-us/unreal-engine/horde-storage-for-unreal-engine?application_version=5.7#layers)
* [Bundles](/documentation/en-us/unreal-engine/horde-storage-for-unreal-engine?application_version=5.7#bundles)
* [Locators](/documentation/en-us/unreal-engine/horde-storage-for-unreal-engine?application_version=5.7#locators)
