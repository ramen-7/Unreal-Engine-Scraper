<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/horde-devices-for-unreal-engine?application_version=5.7 -->
...
An overview of Horde Devices.

![Horde Devices](https://dev.epicgames.com/community/api/documentation/image/4d5a5aeb-fe32-485e-b6cc-04ca0c720f58?resizing_type=fill&width=1920&height=335)
...
* [Shared Pools](/documentation/en-us/unreal-engine/horde-devices-for-unreal-engine?application_version=5.7#sharedpools)
* [Automation Pools](/documentation/en-us/unreal-engine/horde-devices-for-unreal-engine?application_version=5.7#automationpools)
* [Platform and Pool Configuration](/documentation/en-us/unreal-engine/horde-devices-for-unreal-engine?application_version=5.7#platformandpoolconfiguration)
* [Configuration Example](/documentation/en-us/unreal-engine/horde-devices-for-unreal-engine?application_version=5.7#configurationexample)
* [Device Configuration](/documentation/en-us/unreal-engine/horde-devices-for-unreal-engine?application_version=5.7#deviceconfiguration)
* [Gauntlet Integration](/documentation/en-us/unreal-engine/horde-devices-for-unreal-engine?application_version=5.7#gauntletintegration)
* [Gauntlet Integration Example](/documentation/en-us/unreal-engine/horde-devices-for-unreal-engine?application_version=5.7#gauntletintegrationexample)
