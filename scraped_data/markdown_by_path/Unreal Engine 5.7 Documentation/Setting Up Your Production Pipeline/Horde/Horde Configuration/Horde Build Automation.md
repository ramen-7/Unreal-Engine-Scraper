<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/horde-build-automation-for-unreal-engine?application_version=5.7 -->
...
8. Horde Build Automation

# Horde Build Automation

An overview of Horde Build Automation.

![Horde Build Automation](https://dev.epicgames.com/community/api/documentation/image/7ad17bca-3201-48a2-967e-2c305ece44ab?resizing_type=fill&width=1920&height=335)
...
* [BuildGraph](/documentation/en-us/unreal-engine/horde-build-automation-for-unreal-engine?application_version=5.7#buildgraph)
* [Enabling CI Functionality](/documentation/en-us/unreal-engine/horde-build-automation-for-unreal-engine?application_version=5.7#enablingcifunctionality)
* [Agent Types](/documentation/en-us/unreal-engine/horde-build-automation-for-unreal-engine?application_version=5.7#agenttypes)
* [Job Templates](/documentation/en-us/unreal-engine/horde-build-automation-for-unreal-engine?application_version=5.7#jobtemplates)
* [Text Parameters](/documentation/en-us/unreal-engine/horde-build-automation-for-unreal-engine?application_version=5.7#textparameters)
* [List Parameters](/documentation/en-us/unreal-engine/horde-build-automation-for-unreal-engine?application_version=5.7#listparameters)
* [Multi-List Parameters](/documentation/en-us/unreal-engine/horde-build-automation-for-unreal-engine?application_version=5.7#multi-listparameters)
* [Tag-Picker Parameters](/documentation/en-us/unreal-engine/horde-build-automation-for-unreal-engine?application_version=5.7#tag-pickerparameters)
* [Bool Parameters](/documentation/en-us/unreal-engine/horde-build-automation-for-unreal-engine?application_version=5.7#boolparameters)
* [Schedules](/documentation/en-us/unreal-engine/horde-build-automation-for-unreal-engine?application_version=5.7#schedules)
* [Workspaces](/documentation/en-us/unreal-engine/horde-build-automation-for-unreal-engine?application_version=5.7#workspaces)
* [AutoSDK](/documentation/en-us/unreal-engine/horde-build-automation-for-unreal-engine?application_version=5.7#autosdk)
