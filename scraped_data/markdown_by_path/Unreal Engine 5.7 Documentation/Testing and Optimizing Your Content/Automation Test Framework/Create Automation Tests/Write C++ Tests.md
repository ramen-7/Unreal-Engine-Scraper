<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/write-cplusplus-tests-in-unreal-engine?application_version=5.7 -->
...
![Write C++ Tests](https://dev.epicgames.com/community/api/documentation/image/3bb631e8-9d0c-4bf4-831d-26e4d6990689?resizing_type=fill&width=1920&height=335)
...
| `TFlags` | A combination of `EAutomationTestFlags` values, used for specifying Automation Test requirements and behaviors. See [`EAutomationTestFlags`](/documentation/404) for details. |
...
* [Automation Testing](/documentation/en-us/unreal-engine/write-cplusplus-tests-in-unreal-engine?application_version=5.7#automationtesting)
* [Creating a New Automation Test](/documentation/en-us/unreal-engine/write-cplusplus-tests-in-unreal-engine?application_version=5.7#creatinganewautomationtest)
* [Source File Locations](/documentation/en-us/unreal-engine/write-cplusplus-tests-in-unreal-engine?application_version=5.7#sourcefilelocations)
* [Minimal Example](/documentation/en-us/unreal-engine/write-cplusplus-tests-in-unreal-engine?application_version=5.7#minimalexample)
* [Simple Tests](/documentation/en-us/unreal-engine/write-cplusplus-tests-in-unreal-engine?application_version=5.7#simpletests)
* [Complex Tests](/documentation/en-us/unreal-engine/write-cplusplus-tests-in-unreal-engine?application_version=5.7#complextests)
* [Latent Commands](/documentation/en-us/unreal-engine/write-cplusplus-tests-in-unreal-engine?application_version=5.7#latentcommands)
