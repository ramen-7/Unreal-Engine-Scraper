<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/automation-driver-in-unreal-engine?application_version=5.7 -->
...
![Automation Driver](https://dev.epicgames.com/community/api/documentation/image/25f5012a-6e1b-481d-b015-6c8d9ff9f7a8?resizing_type=fill&width=1920&height=335)
...
* [What can it do?](/documentation/en-us/unreal-engine/automation-driver-in-unreal-engine?application_version=5.7#whatcanitdo?)
* [How does it work?](/documentation/en-us/unreal-engine/automation-driver-in-unreal-engine?application_version=5.7#howdoesitwork?)
* [How do I use it?](/documentation/en-us/unreal-engine/automation-driver-in-unreal-engine?application_version=5.7#howdoiuseit?)
* [Using the API](/documentation/en-us/unreal-engine/automation-driver-in-unreal-engine?application_version=5.7#usingtheapi)
* [Finding Elements](/documentation/en-us/unreal-engine/automation-driver-in-unreal-engine?application_version=5.7#findingelements)
* [By::Id()](/documentation/en-us/unreal-engine/automation-driver-in-unreal-engine?application_version=5.7#by::id())
* [By::Path()](/documentation/en-us/unreal-engine/automation-driver-in-unreal-engine?application_version=5.7#by::path())
* [Path Syntax](/documentation/en-us/unreal-engine/automation-driver-in-unreal-engine?application_version=5.7#pathsyntax)
* [By::Cursor()](/documentation/en-us/unreal-engine/automation-driver-in-unreal-engine?application_version=5.7#by::cursor())
* [By::Delegate()](/documentation/en-us/unreal-engine/automation-driver-in-unreal-engine?application_version=5.7#by::delegate())
* [Performing Actions](/documentation/en-us/unreal-engine/automation-driver-in-unreal-engine?application_version=5.7#performingactions)
* [Elements](/documentation/en-us/unreal-engine/automation-driver-in-unreal-engine?application_version=5.7#elements)
* [Sequences](/documentation/en-us/unreal-engine/automation-driver-in-unreal-engine?application_version=5.7#sequences)
* [Actions](/documentation/en-us/unreal-engine/automation-driver-in-unreal-engine?application_version=5.7#actions)
* [Waiting](/documentation/en-us/unreal-engine/automation-driver-in-unreal-engine?application_version=5.7#waiting)
* [Putting It All Together](/documentation/en-us/unreal-engine/automation-driver-in-unreal-engine?application_version=5.7#puttingitalltogether)
* [Final Notes](/documentation/en-us/unreal-engine/automation-driver-in-unreal-engine?application_version=5.7#finalnotes)
