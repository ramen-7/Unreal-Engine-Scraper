<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/indirect-lighting-cache-in-unreal-engine?application_version=5.7 -->
...
4. Indirect Lighting Cache

# Indirect Lighting Cache

Cached indirect lighting samples used for global illumination of dynamic objects and unbuilt scene preview.

![Indirect Lighting Cache](https://dev.epicgames.com/community/api/documentation/image/73756f19-1242-4972-be19-f8d408e25fdf?resizing_type=fill&width=1920&height=335)
...
* [How it works](/documentation/en-us/unreal-engine/indirect-lighting-cache-in-unreal-engine?application_version=5.7#howitworks)
* [Previewing Unbuilt Lighting](/documentation/en-us/unreal-engine/indirect-lighting-cache-in-unreal-engine?application_version=5.7#previewingunbuiltlighting)
