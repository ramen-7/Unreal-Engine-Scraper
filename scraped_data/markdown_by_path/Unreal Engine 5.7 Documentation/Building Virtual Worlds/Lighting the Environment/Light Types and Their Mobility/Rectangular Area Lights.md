<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/rectangular-area-lights-in-unreal-engine?application_version=5.7 -->
...
8. Rectangular Area Lights

# Rectangular Area Lights

The basics of undestanding rectangular area lights.

![Rectangular Area Lights](https://dev.epicgames.com/community/api/documentation/image/717739e2-9292-4419-bc59-ca03532706d2?resizing_type=fill&width=1920&height=335)
...
* [Rect Light Properties](/documentation/en-us/unreal-engine/rectangular-area-lights-in-unreal-engine?application_version=5.7#rectlightproperties)
* [Light](/documentation/en-us/unreal-engine/rectangular-area-lights-in-unreal-engine?application_version=5.7#light)
* [Lightmass](/documentation/en-us/unreal-engine/rectangular-area-lights-in-unreal-engine?application_version=5.7#lightmass)
* [Light Functions](/documentation/en-us/unreal-engine/rectangular-area-lights-in-unreal-engine?application_version=5.7#lightfunctions)
* [Light Profiles](/documentation/en-us/unreal-engine/rectangular-area-lights-in-unreal-engine?application_version=5.7#lightprofiles)
