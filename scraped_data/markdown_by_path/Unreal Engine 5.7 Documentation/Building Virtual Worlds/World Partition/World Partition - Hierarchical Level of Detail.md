<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/world-partition---hierarchical-level-of-detail-in-unreal-engine?application_version=5.7 -->
...
7. World Partition - Hierarchical Level of Detail

# World Partition - Hierarchical Level of Detail

How to use Hierarchical Levels of Detail in your World Partition world.

![World Partition - Hierarchical Level of Detail](https://dev.epicgames.com/community/api/documentation/image/7fdaaf75-46b9-4fd7-acad-c82926e35c3b?resizing_type=fill&width=1920&height=335)
...
* [Creating HLOD Layers](/documentation/en-us/unreal-engine/world-partition---hierarchical-level-of-detail-in-unreal-engine?application_version=5.7#creatinghlodlayers)
* [Choosing a Layer Type](/documentation/en-us/unreal-engine/world-partition---hierarchical-level-of-detail-in-unreal-engine?application_version=5.7#choosingalayertype)
* [Mesh Merge Settings](/documentation/en-us/unreal-engine/world-partition---hierarchical-level-of-detail-in-unreal-engine?application_version=5.7#meshmergesettings)
* [Proxy Settings](/documentation/en-us/unreal-engine/world-partition---hierarchical-level-of-detail-in-unreal-engine?application_version=5.7#proxysettings)
* [Using HLOD Layers](/documentation/en-us/unreal-engine/world-partition---hierarchical-level-of-detail-in-unreal-engine?application_version=5.7#usinghlodlayers)
* [Adding Actors](/documentation/en-us/unreal-engine/world-partition---hierarchical-level-of-detail-in-unreal-engine?application_version=5.7#addingactors)
* [Generating HLODs Using the Commandlet](/documentation/en-us/unreal-engine/world-partition---hierarchical-level-of-detail-in-unreal-engine?application_version=5.7#generatinghlodsusingthecommandlet)
* [Visualizing HLODs](/documentation/en-us/unreal-engine/world-partition---hierarchical-level-of-detail-in-unreal-engine?application_version=5.7#visualizinghlods)
* [In the Editor](/documentation/en-us/unreal-engine/world-partition---hierarchical-level-of-detail-in-unreal-engine?application_version=5.7#intheeditor)
* [At Runtime](/documentation/en-us/unreal-engine/world-partition---hierarchical-level-of-detail-in-unreal-engine?application_version=5.7#atruntime)
