<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/online-subsystem-external-ui-interface-in-unreal-engine?application_version=5.7 -->
...
8. Online Subsystem External UI Interface

# Online Subsystem External UI Interface

Overview of the external UI interface

![Online Subsystem External UI Interface](https://dev.epicgames.com/community/api/documentation/image/d71db12f-e156-43f5-b6ab-2dc107ad2d94?resizing_type=fill&width=1920&height=335)
...
While the [Identity Interface](/documentation/404) is the usual place to handle authentication functionality, certain platforms may require that you go through their user interface flow, or it may simply be more convenient (and more consistent) than writing your own login user interface flow.
...
For more direct interaction with the Friends list, refer to the [Friends Interface](/documentation/404) page.
...
For more information, refer to the [Sessions and Matchmaking](/documentation/en-us/unreal-engine/online-subsystem-session-interface-in-unreal-engine) page.
...
To manage a user's Achievements, use the [Achievements Interface](/documentation/en-us/unreal-engine/online-subsystem-achievements-interface-in-unreal-engine).
...
* [Using External User Interfaces](/documentation/en-us/unreal-engine/online-subsystem-external-ui-interface-in-unreal-engine?application_version=5.7#usingexternaluserinterfaces)
* [Showing a Message Box](/documentation/en-us/unreal-engine/online-subsystem-external-ui-interface-in-unreal-engine?application_version=5.7#showingamessagebox)
* [Viewing a User Profile](/documentation/en-us/unreal-engine/online-subsystem-external-ui-interface-in-unreal-engine?application_version=5.7#viewingauserprofile)
* [Logging In](/documentation/en-us/unreal-engine/online-subsystem-external-ui-interface-in-unreal-engine?application_version=5.7#loggingin)
* [Using the Friends List](/documentation/en-us/unreal-engine/online-subsystem-external-ui-interface-in-unreal-engine?application_version=5.7#usingthefriendslist)
* [Sending an Invitation](/documentation/en-us/unreal-engine/online-subsystem-external-ui-interface-in-unreal-engine?application_version=5.7#sendinganinvitation)
* [Sending a Message to Another User](/documentation/en-us/unreal-engine/online-subsystem-external-ui-interface-in-unreal-engine?application_version=5.7#sendingamessagetoanotheruser)
* [Viewing Achievements](/documentation/en-us/unreal-engine/online-subsystem-external-ui-interface-in-unreal-engine?application_version=5.7#viewingachievements)
* [Creating or Upgrading an Account](/documentation/en-us/unreal-engine/online-subsystem-external-ui-interface-in-unreal-engine?application_version=5.7#creatingorupgradinganaccount)
* [Visiting the Store](/documentation/en-us/unreal-engine/online-subsystem-external-ui-interface-in-unreal-engine?application_version=5.7#visitingthestore)
* [Visiting External Websites](/documentation/en-us/unreal-engine/online-subsystem-external-ui-interface-in-unreal-engine?application_version=5.7#visitingexternalwebsites)
