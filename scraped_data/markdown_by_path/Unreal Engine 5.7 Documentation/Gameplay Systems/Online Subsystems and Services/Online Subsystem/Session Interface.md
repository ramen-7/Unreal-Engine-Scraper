<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/online-subsystem-session-interface-in-unreal-engine?application_version=5.7 -->
...
![Session Interface](https://dev.epicgames.com/community/api/documentation/image/51297071-a7b9-4be9-be09-bfb005e9deef?resizing_type=fill&width=1920&height=335)
...
Once that session is found, the player can [join the session](/documentation/en-us/unreal-engine/online-subsystem-session-interface-in-unreal-engine#joinsession).
...
* [Session Interface](/documentation/en-us/unreal-engine/online-subsystem-session-interface-in-unreal-engine?application_version=5.7#sessioninterface)
* [Session Settings](/documentation/en-us/unreal-engine/online-subsystem-session-interface-in-unreal-engine?application_version=5.7#sessionsettings)
* [Session Management](/documentation/en-us/unreal-engine/online-subsystem-session-interface-in-unreal-engine?application_version=5.7#sessionmanagement)
* [Creating Sessions](/documentation/en-us/unreal-engine/online-subsystem-session-interface-in-unreal-engine?application_version=5.7#creatingsessions)
* [Updating Sessions](/documentation/en-us/unreal-engine/online-subsystem-session-interface-in-unreal-engine?application_version=5.7#updatingsessions)
* [Destroying Sessions](/documentation/en-us/unreal-engine/online-subsystem-session-interface-in-unreal-engine?application_version=5.7#destroyingsessions)
* [Matchmaking - Finding sessions](/documentation/en-us/unreal-engine/online-subsystem-session-interface-in-unreal-engine?application_version=5.7#matchmaking-findingsessions)
* [Searching Sessions](/documentation/en-us/unreal-engine/online-subsystem-session-interface-in-unreal-engine?application_version=5.7#searchingsessions)
* [Cloud-Based Matchmaking](/documentation/en-us/unreal-engine/online-subsystem-session-interface-in-unreal-engine?application_version=5.7#cloud-basedmatchmaking)
* [Following and Inviting Friends](/documentation/en-us/unreal-engine/online-subsystem-session-interface-in-unreal-engine?application_version=5.7#followingandinvitingfriends)
* [Joining Sessions](/documentation/en-us/unreal-engine/online-subsystem-session-interface-in-unreal-engine?application_version=5.7#joiningsessions)
