<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/applying-a-physical-animation-profile-in-unreal-engine?application_version=5.7 -->
...
9. Applying a Physical Animation Profile

# Applying a Physical Animation Profile

This how-to will show you how to apply a Physical Animation Profile to a Skeletal Mesh Component using Blueprints.

![Applying a Physical Animation Profile](https://dev.epicgames.com/community/api/documentation/image/ffe10be3-4701-479b-95a3-1ef18f8be8ce?resizing_type=fill&width=1920&height=335)
...
2. Adjust the Skeletal Mesh Component **Collision** settings.
   * The **Collision Preset** needs to be changed so that Skeletal Mesh Component has **Collision Enabled** and so that it doesn't interact with Pawns:
     ...
     how the **Capsule** interacts with that Object Type. See: **[AddCustomCollisionType](/documentation/en-us/unreal-engine/add-a-custom-object-type-to-your-project-in-unreal-engine)**, for more information on creating **Custom Collision Channels**.
...
12. Connect the **Set All Bodies Below Simulate Physics** node to the **Apply Physical Animation Profile Below** node. This will complete our graph.
    ...
    * Again, since you are using `spine_01` as the target bone, **Include Self** should be enabled.Copy code

    Begin Object Class=K2Node\_Event Name="K2Node\_Event\_0"
...
* [Steps](/documentation/en-us/unreal-engine/applying-a-physical-animation-profile-in-unreal-engine?application_version=5.7#steps)
* [Result](/documentation/en-us/unreal-engine/applying-a-physical-animation-profile-in-unreal-engine?application_version=5.7#result)
* [Additional Resources](/documentation/en-us/unreal-engine/applying-a-physical-animation-profile-in-unreal-engine?application_version=5.7#additionalresources)
