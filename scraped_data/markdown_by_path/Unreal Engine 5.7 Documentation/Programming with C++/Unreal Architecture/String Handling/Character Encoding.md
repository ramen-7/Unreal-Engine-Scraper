<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/character-encoding-in-unreal-engine?application_version=5.7 -->
...
![Character Encoding](https://dev.epicgames.com/community/api/documentation/image/f91a0e9a-ded6-488a-bcf4-d36048633040?resizing_type=fill&width=1920&height=335)
...
* [Text Formats](/documentation/en-us/unreal-engine/character-encoding-in-unreal-engine?application_version=5.7#textformats)
* [The Case for Binary](/documentation/en-us/unreal-engine/character-encoding-in-unreal-engine?application_version=5.7#thecaseforbinary)
* [The Case for Text](/documentation/en-us/unreal-engine/character-encoding-in-unreal-engine?application_version=5.7#thecasefortext)
* [The Case for UTF-8](/documentation/en-us/unreal-engine/character-encoding-in-unreal-engine?application_version=5.7#thecaseforutf-8)
* [The Case for UTF-16](/documentation/en-us/unreal-engine/character-encoding-in-unreal-engine?application_version=5.7#thecaseforutf-16)
* [UE Internal String Representation](/documentation/en-us/unreal-engine/character-encoding-in-unreal-engine?application_version=5.7#ueinternalstringrepresentation)
* [Text Files Loaded by UE](/documentation/en-us/unreal-engine/character-encoding-in-unreal-engine?application_version=5.7#textfilesloadedbyue)
* [Text Files Saved by UE](/documentation/en-us/unreal-engine/character-encoding-in-unreal-engine?application_version=5.7#textfilessavedbyue)
* [Recommended Encoding for Text Files Used by UE](/documentation/en-us/unreal-engine/character-encoding-in-unreal-engine?application_version=5.7#recommendedencodingfortextfilesusedbyue)
* [INT and INI Files](/documentation/en-us/unreal-engine/character-encoding-in-unreal-engine?application_version=5.7#intandinifiles)
* [Source Code](/documentation/en-us/unreal-engine/character-encoding-in-unreal-engine?application_version=5.7#sourcecode)
* [C++ Source Code](/documentation/en-us/unreal-engine/character-encoding-in-unreal-engine?application_version=5.7#c++sourcecode)
* [Storing UTF-16 Text Files in Perforce](/documentation/en-us/unreal-engine/character-encoding-in-unreal-engine?application_version=5.7#storingutf-16textfilesinperforce)
* [Conversion Routines](/documentation/en-us/unreal-engine/character-encoding-in-unreal-engine?application_version=5.7#conversionroutines)
* [ToUpper() and ToLower() Non-Trivial in Unicode](/documentation/en-us/unreal-engine/character-encoding-in-unreal-engine?application_version=5.7#toupper()andtolower()non-trivialinunicode)
* [Notes about C++ Source Code Specific to East Asian Encodings](/documentation/en-us/unreal-engine/character-encoding-in-unreal-engine?application_version=5.7#notesaboutc++sourcecodespecifictoeastasianencodings)
