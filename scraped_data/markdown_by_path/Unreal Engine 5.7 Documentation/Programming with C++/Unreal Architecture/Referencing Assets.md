<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/referencing-assets-in-unreal-engine?application_version=5.7 -->
...
7. Referencing Assets

# Referencing Assets

Control how an asset is referenced and loaded into memory.

![Referencing Assets](https://dev.epicgames.com/community/api/documentation/image/9251e96b-7ef1-4eb2-89f7-936defeede9b?resizing_type=fill&width=1920&height=335)
...
* [Direct Property Reference](/documentation/en-us/unreal-engine/referencing-assets-in-unreal-engine?application_version=5.7#directpropertyreference)
* [Construction Time Reference](/documentation/en-us/unreal-engine/referencing-assets-in-unreal-engine?application_version=5.7#constructiontimereference)
* [Indirect Property Reference](/documentation/en-us/unreal-engine/referencing-assets-in-unreal-engine?application_version=5.7#indirectpropertyreference)
* [Find/Load Object](/documentation/en-us/unreal-engine/referencing-assets-in-unreal-engine?application_version=5.7#find/loadobject)
