<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/unreal-object-handling-in-unreal-engine?application_version=5.7 -->
...
8. Unreal Object Handling

# Unreal Object Handling

Overview of the features of the UObject system.

![Unreal Object Handling](https://dev.epicgames.com/community/api/documentation/image/4a2dd0d2-c7d7-4fea-ae75-7635eb423324?resizing_type=fill&width=1920&height=335)
...
`UFunctions` can also be tagged to [execute on a remote machine](/documentation/404). A "server" function, for example, when called on a client machine, will cause the function to execute on the server machine for the server's version of the Actor. A "client" function, on the other hand, can be called from the server and will run on the owning client's version of that Actor.
...
* [Automatic Property Initialization](/documentation/en-us/unreal-engine/unreal-object-handling-in-unreal-engine?application_version=5.7#automaticpropertyinitialization)
* [Automatic Updating of References](/documentation/en-us/unreal-engine/unreal-object-handling-in-unreal-engine?application_version=5.7#automaticupdatingofreferences)
* [Serialization](/documentation/en-us/unreal-engine/unreal-object-handling-in-unreal-engine?application_version=5.7#serialization)
* [Updating of Property Values](/documentation/en-us/unreal-engine/unreal-object-handling-in-unreal-engine?application_version=5.7#updatingofpropertyvalues)
* [Editor Integration](/documentation/en-us/unreal-engine/unreal-object-handling-in-unreal-engine?application_version=5.7#editorintegration)
* [Run-Time Type Information and Casting](/documentation/en-us/unreal-engine/unreal-object-handling-in-unreal-engine?application_version=5.7#run-timetypeinformationandcasting)
* [Garbage Collection](/documentation/en-us/unreal-engine/unreal-object-handling-in-unreal-engine?application_version=5.7#garbagecollection)
* [Network Replication](/documentation/en-us/unreal-engine/unreal-object-handling-in-unreal-engine?application_version=5.7#networkreplication)
