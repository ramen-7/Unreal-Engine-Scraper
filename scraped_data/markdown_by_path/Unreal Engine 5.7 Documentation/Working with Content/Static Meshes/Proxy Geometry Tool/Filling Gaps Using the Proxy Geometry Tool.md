<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/filling-gaps-using-the-proxy-geometry-tool-in-unreal-engine?application_version=5.7 -->
...
8. Filling Gaps Using the Proxy Geometry Tool

# Filling Gaps Using the Proxy Geometry Tool

Using the Proxy Geometry tool to automatically fill in gaps when creating new geometry.

![Filling Gaps Using the Proxy Geometry Tool](https://dev.epicgames.com/community/api/documentation/image/4f6880df-65ef-4431-a38a-b8200a52f795?resizing_type=fill&width=1920&height=335)
...
9. To fix issues like this, first re-select all the Static Meshes that make up your object. Then in the Merge Actors tool, and increase the **Merge Distance** to a value of **175.** Then enable the **Transfer Distance Override** and set it to a value of **100**.
   ...
   [![undefined](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/3100c613-b495-4a81-9125-ca040bdd45d8/gapfilling_06.png)](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/3100c613-b495-4a81-9125-ca040bdd45d8/gapfilling_06.png)
...
![Example of what happens when both the Merge Distance and Transfer Distance Override are set to values of 0, 100, 200, and 300.](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/4440369f-4de9-48f2-945f-32614dd1c075/setto0.png)
![Example of what happens when both the Merge Distance and Transfer Distance Override are set to values of 0, 100, 200, and 300.](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/c5e4a47d-9251-4c5f-af2a-341bac346b55/setto100.png)
![Example of what happens when both the Merge Distance and Transfer Distance Override are set to values of 0, 100, 200, and 300.](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/a59abb39-b439-4a7e-929d-2f24e3d20011/setto200.png)
![Example of what happens when both the Merge Distance and Transfer Distance Override are set to values of 0, 100, 200, and 300.](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/ede74150-1b73-4ed7-8437-7d414e95f946/setto300.png)
...
* [Steps](/documentation/en-us/unreal-engine/filling-gaps-using-the-proxy-geometry-tool-in-unreal-engine?application_version=5.7#steps)
* [End Results](/documentation/en-us/unreal-engine/filling-gaps-using-the-proxy-geometry-tool-in-unreal-engine?application_version=5.7#endresults)
