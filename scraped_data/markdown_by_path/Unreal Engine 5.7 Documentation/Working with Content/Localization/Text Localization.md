<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7 -->
...
![Text Localization](https://dev.epicgames.com/community/api/documentation/image/899844d3-345d-456f-b3f6-ffcd9155794e?resizing_type=fill&width=1920&height=335)
...
| --- | --- |
| ``` 	Result `{ {Res} } Copy full snippet ``` | ``` 	Result { 10 } Copy full snippet ``` |
| ``` 	Result \`\`{Res}\`\`   Copy full snippet ``` | ``` 	Result \`10\` Copy full snippet ``` |
...
* [Text Literals](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#textliterals)
* [Creating Text Literals in C++](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#creatingtextliteralsinc++)
* [Creating Text Literals in INI Files](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#creatingtextliteralsininifiles)
* [Creating Text Literals in Assets](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#creatingtextliteralsinassets)
* [Text Formatting](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#textformatting)
* [Text Formatting in C++](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#textformattinginc++)
* [Text Formatting in Blueprints](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#textformattinginblueprints)
* [Argument Modifiers](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#argumentmodifiers)
* [Plural Forms](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#pluralforms)
* [Gender Forms](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#genderforms)
* [Hangul Post-Positions](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#hangulpost-positions)
* [Text Formatting Best Practices](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#textformattingbestpractices)
* [Text Generation](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#textgeneration)
* [Numerical Text Generation](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#numericaltextgeneration)
* [Numerical Generation in C++](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#numericalgenerationinc++)
* [Numerical Generation in Blueprints](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#numericalgenerationinblueprints)
* [Chronological](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#chronological)
* [Chronological Generation in C++](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#chronologicalgenerationinc++)
* [Chronological Generation in Blueprints](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#chronologicalgenerationinblueprints)
* [Transformative](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#transformative)
* [Transformative Generation in C++](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#transformativegenerationinc++)
* [Transformative Generation in Blueprints](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#transformativegenerationinblueprints)
* [String Tables](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#stringtables)
* [Text Value Marshalling](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#textvaluemarshalling)
* [Data Tables](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#datatables)
* [Polyglot Data](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#polyglotdata)
* [Polyglot Data in C++](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#polyglotdatainc++)
* [Polyglot Data in Blueprints](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#polyglotdatainblueprints)
* [Localized Text Sources](/documentation/en-us/unreal-engine/text-localization-in-unreal-engine?application_version=5.7#localizedtextsources)

Related documents

[String Handling

![String Handling](https://dev.epicgames.com/community/api/documentation/image/25f8a534-28f8-4d25-8dc4-c797c50e9782?resizing_type=fit&width=160&height=92)](/documentation/en-us/unreal-engine/string-handling-in-unreal-engine)
