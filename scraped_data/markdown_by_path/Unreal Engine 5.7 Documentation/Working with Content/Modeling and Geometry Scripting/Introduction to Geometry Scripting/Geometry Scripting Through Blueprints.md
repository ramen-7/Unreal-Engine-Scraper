<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/geometry-scripting-through-blueprints-in-unreal-engine?application_version=5.7 -->
...
8. Geometry Scripting Through Blueprints
...
This guide uses the [Third Person template](/documentation/404). However, you can use any project to follow along.
...
[![undefined](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/1133e01e-7ccc-48d7-af68-5ae77d8cf9e8/procedural-mesh-blueprint-5-5.png)](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/1133e01e-7ccc-48d7-af68-5ae77d8cf9e8/procedural-mesh-blueprint-5-5.png)
...
* [Prerequisite Knowledge](/documentation/en-us/unreal-engine/geometry-scripting-through-blueprints-in-unreal-engine?application_version=5.7#prerequisiteknowledge)
* [Enabling Plugin](/documentation/en-us/unreal-engine/geometry-scripting-through-blueprints-in-unreal-engine?application_version=5.7#enablingplugin)
* [Creating a Blueprint Class](/documentation/en-us/unreal-engine/geometry-scripting-through-blueprints-in-unreal-engine?application_version=5.7#creatingablueprintclass)
* [Event Setup](/documentation/en-us/unreal-engine/geometry-scripting-through-blueprints-in-unreal-engine?application_version=5.7#eventsetup)
* [Building Geometry](/documentation/en-us/unreal-engine/geometry-scripting-through-blueprints-in-unreal-engine?application_version=5.7#buildinggeometry)
* [Adding Transformation Widget](/documentation/en-us/unreal-engine/geometry-scripting-through-blueprints-in-unreal-engine?application_version=5.7#addingtransformationwidget)
* [Editing with Booleans](/documentation/en-us/unreal-engine/geometry-scripting-through-blueprints-in-unreal-engine?application_version=5.7#editingwithbooleans)
* [Adding Widgets](/documentation/en-us/unreal-engine/geometry-scripting-through-blueprints-in-unreal-engine?application_version=5.7#addingwidgets)
* [Bake to Static Mesh Function](/documentation/en-us/unreal-engine/geometry-scripting-through-blueprints-in-unreal-engine?application_version=5.7#baketostaticmeshfunction)
* [Reviewing End Results](/documentation/en-us/unreal-engine/geometry-scripting-through-blueprints-in-unreal-engine?application_version=5.7#reviewingendresults)
* [On Your Own](/documentation/en-us/unreal-engine/geometry-scripting-through-blueprints-in-unreal-engine?application_version=5.7#onyourown)
