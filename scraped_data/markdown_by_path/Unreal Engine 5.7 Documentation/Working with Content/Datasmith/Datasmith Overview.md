<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/datasmith-plugins-overview?application_version=5.7 -->
...
7. Datasmith Overview

# Datasmith Overview

An overview of how Datasmith works, and what you should expect when you use it.

![Datasmith Overview](https://dev.epicgames.com/community/api/documentation/image/5bc77764-a2d9-496f-9000-778fc6380238?resizing_type=fill&width=1920&height=335)
...
[![Datasmith Import Process](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/aa5aab82-d8b5-4b03-8c74-a3e2a88a9230/datasmith_import_process.png)](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/aa5aab82-d8b5-4b03-8c74-a3e2a88a9230/datasmith_import_process.png)
...
[![Datasmith Overview Viewport](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/ee30e530-551c-4ef1-adcb-1c6ae111f413/datasmith_overview_viewport.png)](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/ee30e530-551c-4ef1-adcb-1c6ae111f413/datasmith_overview_viewport.png)
...
* You can selectively roll back the changes that you make to an Asset or Actor in Unreal. This returns all of the information Datasmith tracks about those selected Assets or Actors to the way it was when you first imported your content through Datasmith.
  ...
  [![Datasmith Reset Overrides](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/03f4932d-6c77-4728-b443-a02bab5cb5d3/datasmith-overview-overrides.png)](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/03f4932d-6c77-4728-b443-a02bab5cb5d3/datasmith-overview-overrides.png)
...
* When you reimport a Datasmith Scene, you don't lose any of the tracked overrides you've made in Unreal. For example, if you've moved an Actor to a new position in the scene, or set a different Material for an Actor, Datasmith preserves those changes after you re-import the scene.
  For more information, see [Datasmith Reimport Workflow](/documentation/en-us/unreal-engine/datasmith-reimport-workflow-in-unreal-engine).
...
* [How Datasmith Helps](/documentation/en-us/unreal-engine/datasmith-plugins-overview?application_version=5.7#howdatasmithhelps)
* [The Datasmith Workflow](/documentation/en-us/unreal-engine/datasmith-plugins-overview?application_version=5.7#thedatasmithworkflow)
* [What You Get After Import](/documentation/en-us/unreal-engine/datasmith-plugins-overview?application_version=5.7#whatyougetafterimport)
* [Static Mesh Assets](/documentation/en-us/unreal-engine/datasmith-plugins-overview?application_version=5.7#staticmeshassets)
* [Material Assets](/documentation/en-us/unreal-engine/datasmith-plugins-overview?application_version=5.7#materialassets)
* [Texture Assets](/documentation/en-us/unreal-engine/datasmith-plugins-overview?application_version=5.7#textureassets)
* [Other Asset Types](/documentation/en-us/unreal-engine/datasmith-plugins-overview?application_version=5.7#otherassettypes)
* [The Datasmith Scene Asset](/documentation/en-us/unreal-engine/datasmith-plugins-overview?application_version=5.7#thedatasmithsceneasset)
* [Level Actors and the Scene Hierarchy](/documentation/en-us/unreal-engine/datasmith-plugins-overview?application_version=5.7#levelactorsandthescenehierarchy)
* [Tracking and Handling Overrides](/documentation/en-us/unreal-engine/datasmith-plugins-overview?application_version=5.7#trackingandhandlingoverrides)
* [Properties Tracked as Overrides](/documentation/en-us/unreal-engine/datasmith-plugins-overview?application_version=5.7#propertiestrackedasoverrides)
* [Next Steps](/documentation/en-us/unreal-engine/datasmith-plugins-overview?application_version=5.7#nextsteps)
