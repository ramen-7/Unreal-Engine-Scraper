<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/automotive-hmi-development-in-unreal-engine?application_version=5.7 -->
...
6. Automotive HMI Development

# Automotive HMI Development

Learn about the unique development considerations for automotive HMI developers, as well as Unreal Engine's specialized tools for supporting them.
...
* [Roles and Environments on an HMI Project](/documentation/en-us/unreal-engine/automotive-hmi-development-in-unreal-engine?application_version=5.7#rolesandenvironmentsonanhmiproject)
* [Onboard Your Organization](/documentation/en-us/unreal-engine/automotive-hmi-development-in-unreal-engine?application_version=5.7#onboardyourorganization)
* [Manage Your Application's Performance](/documentation/en-us/unreal-engine/automotive-hmi-development-in-unreal-engine?application_version=5.7#manageyourapplication'sperformance)
* [Basics](/documentation/en-us/unreal-engine/automotive-hmi-development-in-unreal-engine?application_version=5.7#basics)
* [Profiling Tools](/documentation/en-us/unreal-engine/automotive-hmi-development-in-unreal-engine?application_version=5.7#profilingtools)
* [Performance Scaling Resources](/documentation/en-us/unreal-engine/automotive-hmi-development-in-unreal-engine?application_version=5.7#performancescalingresources)
* [Technical Art](/documentation/en-us/unreal-engine/automotive-hmi-development-in-unreal-engine?application_version=5.7#technicalart)
* [UI Development](/documentation/en-us/unreal-engine/automotive-hmi-development-in-unreal-engine?application_version=5.7#uidevelopment)
* [Working With UMG](/documentation/en-us/unreal-engine/automotive-hmi-development-in-unreal-engine?application_version=5.7#workingwithumg)
* [Improving UI Performance](/documentation/en-us/unreal-engine/automotive-hmi-development-in-unreal-engine?application_version=5.7#improvinguiperformance)
* [MacOS](/documentation/en-us/unreal-engine/automotive-hmi-development-in-unreal-engine?application_version=5.7#macos)
* [HMI Engineering and Debugging Resources](/documentation/en-us/unreal-engine/automotive-hmi-development-in-unreal-engine?application_version=5.7#hmiengineeringanddebuggingresources)
* [Linux Development Environment](/documentation/en-us/unreal-engine/automotive-hmi-development-in-unreal-engine?application_version=5.7#linuxdevelopmentenvironment)
* [Debugging Resources](/documentation/en-us/unreal-engine/automotive-hmi-development-in-unreal-engine?application_version=5.7#debuggingresources)
