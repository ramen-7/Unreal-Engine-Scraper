<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/using-mobile-service-leaderboards-in-unreal-engine-projects-for-mobile-devices?application_version=5.7 -->
...
7. Using Mobile Service Leaderboards

# Using Mobile Service Leaderboards

Using Mobile Service Leaderboards in your game.

![Using Mobile Service Leaderboards](https://dev.epicgames.com/community/api/documentation/image/e6956ede-ee88-45fd-962d-67712c7c0a05?resizing_type=fill&width=1920&height=335)
...
* [Configuration](/documentation/en-us/unreal-engine/using-mobile-service-leaderboards-in-unreal-engine-projects-for-mobile-devices?application_version=5.7#configuration)
* [Reading from a Leaderboard](/documentation/en-us/unreal-engine/using-mobile-service-leaderboards-in-unreal-engine-projects-for-mobile-devices?application_version=5.7#readingfromaleaderboard)
* [Writing to a Leaderboard](/documentation/en-us/unreal-engine/using-mobile-service-leaderboards-in-unreal-engine-projects-for-mobile-devices?application_version=5.7#writingtoaleaderboard)
* [Showing the Platform Specific Leadboard](/documentation/en-us/unreal-engine/using-mobile-service-leaderboards-in-unreal-engine-projects-for-mobile-devices?application_version=5.7#showingtheplatformspecificleadboard)
