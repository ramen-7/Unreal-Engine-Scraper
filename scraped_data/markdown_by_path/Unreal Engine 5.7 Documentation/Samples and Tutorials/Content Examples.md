<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/content-examples-sample-project-for-unreal-engine?application_version=5.7 -->
...
![Content Examples](https://dev.epicgames.com/community/api/documentation/image/97925402-f91c-401f-896b-fd25d972e711?resizing_type=fill&width=1920&height=335)
...
4. When the project opens, navigate the entry hallway to learn how to use the project file. Select **File > Open Level** to browse all the available content.
   ...
   [![Open Level](https://dev.epicgames.com/community/api/documentation/image/80477c02-9b24-46a4-b0e3-a87c9251108a?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/80477c02-9b24-46a4-b0e3-a87c9251108a?resizing_type=fit)

   Click image for full size.
5. From the **Maps** folder, choose a level to explore. Click **Open** to open that level.

   [![Available Levels](https://dev.epicgames.com/community/api/documentation/image/6b347e71-2657-4b1a-8f4b-a188743a359c?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/6b347e71-2657-4b1a-8f4b-a188743a359c?resizing_type=fit)
...
* [Installing the Content Examples Sample Project](/documentation/en-us/unreal-engine/content-examples-sample-project-for-unreal-engine?application_version=5.7#installing-the-content-examples-sample-project)
* [Available Content](/documentation/en-us/unreal-engine/content-examples-sample-project-for-unreal-engine?application_version=5.7#available-content)
