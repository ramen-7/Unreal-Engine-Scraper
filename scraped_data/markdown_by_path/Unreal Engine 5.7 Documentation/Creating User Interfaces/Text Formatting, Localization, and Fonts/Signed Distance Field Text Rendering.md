<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/using-signed-distance-field-text-rendering-in-unreal-engine?application_version=5.7 -->
...
7. Signed Distance Field Text Rendering

# Signed Distance Field Text Rendering

Use signed distance field text rendering to make resolution-independent text.

![Signed Distance Field Text Rendering](https://dev.epicgames.com/community/api/documentation/image/e8d48050-bae8-4522-8590-6a6627b8122a?resizing_type=fill&width=1920&height=335)
...
[![Signed Distance Field-based Text Render](https://dev.epicgames.com/community/api/documentation/image/b33b1107-38cd-4a01-b94a-40cde255eae2?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/b33b1107-38cd-4a01-b94a-40cde255eae2?resizing_type=fit)
...
2. Enable the **Enable Distance Field Font Rasterization** setting.
   ...
   [![Enable Distance Field Font Rasterization setting](https://dev.epicgames.com/community/api/documentation/image/6e550ce0-eed1-4a36-8557-6ea034e6e61e?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/6e550ce0-eed1-4a36-8557-6ea034e6e61e?resizing_type=fit)
...
4. In the **Details** panel, locate the **Distance Field Mode** category, then enable the **Enable Distance Field Rendering** setting. When you enable the setting you can configure the quality levels for the single and multi-channel distance field resolution.
   ...
   [![Enable Distance Field Rendering setting](https://dev.epicgames.com/community/api/documentation/image/c6b924fa-e069-4fb1-83ae-d538ae55d23f?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/c6b924fa-e069-4fb1-83ae-d538ae55d23f?resizing_type=fit)
...
[![Material Effect Node](https://dev.epicgames.com/community/api/documentation/image/1a174ac8-da37-48a0-87ea-8b4b31f47274?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/1a174ac8-da37-48a0-87ea-8b4b31f47274?resizing_type=fit)
...
[![Font Matrial](https://dev.epicgames.com/community/api/documentation/image/2df5ee68-b783-45c9-970b-30091c9453e3?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/2df5ee68-b783-45c9-970b-30091c9453e3?resizing_type=fit)
...
* [Pros](/documentation/en-us/unreal-engine/using-signed-distance-field-text-rendering-in-unreal-engine?application_version=5.7#pros)
* [Cons](/documentation/en-us/unreal-engine/using-signed-distance-field-text-rendering-in-unreal-engine?application_version=5.7#cons)
* [Setup and Use](/documentation/en-us/unreal-engine/using-signed-distance-field-text-rendering-in-unreal-engine?application_version=5.7#setup-and-use)
* [Configuration](/documentation/en-us/unreal-engine/using-signed-distance-field-text-rendering-in-unreal-engine?application_version=5.7#configuration)
* [Material effects](/documentation/en-us/unreal-engine/using-signed-distance-field-text-rendering-in-unreal-engine?application_version=5.7#material-effects)
