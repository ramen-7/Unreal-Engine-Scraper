<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/node-reference/ControlRig/ScaleConstraint?application_version=5.7 -->
...
| Tags | Parent, Size |
| Type | [FRigUnit\_ScaleConstraintLocalSpaceOffset](/documentation/en-us/unreal-engine/API/Plugins/ControlRig/FRigUnit_ScaleConstraintLocalSpa-) |
...
* [Description](/documentation/en-us/unreal-engine/node-reference/ControlRig/ScaleConstraint?application_version=5.7#description)
* [Information](/documentation/en-us/unreal-engine/node-reference/ControlRig/ScaleConstraint?application_version=5.7#information)
* [IO](/documentation/en-us/unreal-engine/node-reference/ControlRig/ScaleConstraint?application_version=5.7#io)
* [Inputs](/documentation/en-us/unreal-engine/node-reference/ControlRig/ScaleConstraint?application_version=5.7#inputs)
