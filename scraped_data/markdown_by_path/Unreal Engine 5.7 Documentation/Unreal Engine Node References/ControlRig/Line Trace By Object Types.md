<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/node-reference/ControlRig/LineTraceByObjectTypes?application_version=5.7 -->
...
7. Line Trace By Object Types

# Line Trace By Object Types

Performs a line trace against the world and return the first blocking hit.
...
| Type | [FRigUnit\_LineTraceByObjectTypes](/documentation/en-us/unreal-engine/API/Plugins/ControlRig/FRigUnit_LineTraceByObjectTypes) |
...
* [Description](/documentation/en-us/unreal-engine/node-reference/ControlRig/LineTraceByObjectTypes?application_version=5.7#description)
* [Information](/documentation/en-us/unreal-engine/node-reference/ControlRig/LineTraceByObjectTypes?application_version=5.7#information)
* [Inputs](/documentation/en-us/unreal-engine/node-reference/ControlRig/LineTraceByObjectTypes?application_version=5.7#inputs)
* [Outputs](/documentation/en-us/unreal-engine/node-reference/ControlRig/LineTraceByObjectTypes?application_version=5.7#outputs)
