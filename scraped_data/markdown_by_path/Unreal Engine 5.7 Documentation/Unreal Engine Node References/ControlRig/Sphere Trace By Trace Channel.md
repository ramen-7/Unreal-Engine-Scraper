<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/node-reference/ControlRig/SphereTraceByTraceChannel?application_version=5.7 -->
...
7. Sphere Trace By Trace Channel
...
| Type | [FRigUnit\_SphereTraceByTraceChannel](/documentation/en-us/unreal-engine/API/Plugins/ControlRig/FRigUnit_SphereTraceByTraceChann-) |
...
* [Description](/documentation/en-us/unreal-engine/node-reference/ControlRig/SphereTraceByTraceChannel?application_version=5.7#description)
* [Information](/documentation/en-us/unreal-engine/node-reference/ControlRig/SphereTraceByTraceChannel?application_version=5.7#information)
* [Inputs](/documentation/en-us/unreal-engine/node-reference/ControlRig/SphereTraceByTraceChannel?application_version=5.7#inputs)
* [Outputs](/documentation/en-us/unreal-engine/node-reference/ControlRig/SphereTraceByTraceChannel?application_version=5.7#outputs)
