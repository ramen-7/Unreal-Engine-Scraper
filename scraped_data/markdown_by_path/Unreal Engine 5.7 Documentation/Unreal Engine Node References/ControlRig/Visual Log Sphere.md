<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/node-reference/ControlRig/VisualLogSphere?application_version=5.7 -->
...
| Category | Debug |
| Tags | Draw,String |
| Type | [FRigVMFunction\_VisualLogSphere](/documentation/en-us/unreal-engine/API/Plugins/RigVM/FRigVMFunction_VisualLogSphere) |
...
| Name | Description | Permitted Types | Default Value |
| --- | --- | --- | --- |
| Center | The centre of the sphere | [Vector](/documentation/en-us/unreal-engine/API/Runtime/Core) | (X=0.000000,Y=0.000000,Z=0.000000) |
| Radius | The radius of the sphere | [float](/documentation/en-us/unreal-engine/API/Runtime/uLangCore) | 10.000000 |
...
* [Description](/documentation/en-us/unreal-engine/node-reference/ControlRig/VisualLogSphere?application_version=5.7#description)
* [Information](/documentation/en-us/unreal-engine/node-reference/ControlRig/VisualLogSphere?application_version=5.7#information)
* [IO](/documentation/en-us/unreal-engine/node-reference/ControlRig/VisualLogSphere?application_version=5.7#io)
* [Inputs](/documentation/en-us/unreal-engine/node-reference/ControlRig/VisualLogSphere?application_version=5.7#inputs)
