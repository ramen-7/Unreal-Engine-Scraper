<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/node-reference/ControlRig/SpringInterpolate?application_version=5.7 -->
...
| Type | [FRigUnit\_SpringInterpQuaternionV2](/documentation/en-us/unreal-engine/API/Plugins/ControlRig/FRigUnit_SpringInterpQuaternionV-) |

### Inputs

| Name | Description | Permitted Types | Default Value |
| --- | --- | --- | --- |
| Target | Rest/target position of the spring. | [Quat](/documentation/en-us/unreal-engine/API/Runtime/Core) | (X=0.000000,Y=0.000000,Z=0.000000,W=1.000000) |
...
| Torque | Extra torque to apply (since the moment of inertia is 1, this is also the angular acceleration). | [Vector](/documentation/en-us/unreal-engine/API/Runtime/Core) | (X=0.000000,Y=0.000000,Z=0.000000) |
...
| Current | Current position of the spring. | [Quat](/documentation/en-us/unreal-engine/API/Runtime/Core) | (X=0.000000,Y=0.000000,Z=0.000000,W=1.000000) |
...
| Name | Description | Permitted Types | Default Value |
| --- | --- | --- | --- |
| Result | New position of the spring after delta time. | [Quat](/documentation/en-us/unreal-engine/API/Runtime/Core) |  |
| AngularVelocity | Angular velocity | [Vector](/documentation/en-us/unreal-engine/API/Runtime/Core) |  |
...
* [Description](/documentation/en-us/unreal-engine/node-reference/ControlRig/SpringInterpolate?application_version=5.7#description)
* [Information](/documentation/en-us/unreal-engine/node-reference/ControlRig/SpringInterpolate?application_version=5.7#information)
* [Inputs](/documentation/en-us/unreal-engine/node-reference/ControlRig/SpringInterpolate?application_version=5.7#inputs)
* [Outputs](/documentation/en-us/unreal-engine/node-reference/ControlRig/SpringInterpolate?application_version=5.7#outputs)
