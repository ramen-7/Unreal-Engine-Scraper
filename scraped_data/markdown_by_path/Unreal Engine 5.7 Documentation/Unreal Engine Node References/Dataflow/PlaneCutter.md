<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/node-reference/Dataflow/PlaneCutter?application_version=5.7 -->
...
| Type | [FPlaneCutterDataflowNode\_v2](/documentation/en-us/unreal-engine/API/Plugins/GeometryCollectionNodes/FPlaneCutterDataflowNode_v2) |
...
| RenderType |  | [EDataflowDebugDrawRenderType](/documentation/en-us/unreal-engine/API/Runtime/DataflowEngine/EDataflowDebugDrawRenderType) | Wireframe |
| PlaneSizeMultiplier |  | [float](/documentation/en-us/unreal-engine/API/Runtime/uLangCore) | 2.200000 |
| bTranslucent |  | [bool](/documentation/en-us/unreal-engine/API/Runtime/Core) | True |
| bRandomizeColors |  | [bool](/documentation/en-us/unreal-engine/API/Runtime/Core) | True |
| ColorRandomSeed |  | [int32](/documentation/en-us/unreal-engine/API/Runtime/Core) | 0 |
| LineWidthMultiplier |  | [float](/documentation/en-us/unreal-engine/API/Runtime/uLangCore) | 1.000000 |
...
| BoundingBox | Bound for plane centers | [FBox](/documentation/en-us/unreal-engine/API/Runtime/Core) | (Min=(X=0.000000,Y=0.000000,Z=0.000000),Max=(X=0.000000,Y=0.000000,Z=0.000000),IsValid=False) |
| TransformSelection | Pieces to cut | [FDataflowTransformSelection](/documentation/en-us/unreal-engine/API/Runtime/DataflowCore/FDataflowTransformSelection) | () |
| Transform | Transform to bring the collection into the space of the cutting planes | [FTransform](/documentation/en-us/unreal-engine/API/Runtime/Core) | (Rotation=(X=0.000000,Y=0.000000,Z=0.000000,W=1.000000),Translation=(X=0.000000,Y=0.000000,Z=0.000000),Scale3D=(X=1.000000,Y=1.000000,Z=1.000000)) |
| NumPlanes | Number of random cutting planes to add, in addition to those specified in the Cut Planes array | [int32](/documentation/en-us/unreal-engine/API/Runtime/Core) | 0 |
| CutPlanes | Cutting planes to use. The cut plane normal is aligned to the Z-up of the transform. | [TArray](/documentation/en-us/unreal-engine/API/Runtime/Core/TArray)<[FTransform](/documentation/en-us/unreal-engine/API/Runtime/Core)> |  |
...
| PointSpacing | Distance (in cm) between vertices on cut surfaces where noise is added. Larger spacing between vertices will create more efficient meshes with fewer triangles, but less resolution to see the shape of the added noise | [float](/documentation/en-us/unreal-engine/API/Runtime/uLangCore) | 20.000000 |
...
* [Description](/documentation/en-us/unreal-engine/node-reference/Dataflow/PlaneCutter?application_version=5.7#description)
* [Information](/documentation/en-us/unreal-engine/node-reference/Dataflow/PlaneCutter?application_version=5.7#information)
* [Parameters](/documentation/en-us/unreal-engine/node-reference/Dataflow/PlaneCutter?application_version=5.7#parameters)
* [Inputs](/documentation/en-us/unreal-engine/node-reference/Dataflow/PlaneCutter?application_version=5.7#inputs)
* [Outputs](/documentation/en-us/unreal-engine/node-reference/Dataflow/PlaneCutter?application_version=5.7#outputs)
