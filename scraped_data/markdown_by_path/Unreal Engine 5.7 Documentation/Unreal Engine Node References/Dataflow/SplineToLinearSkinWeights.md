<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/node-reference/Dataflow/SplineToLinearSkinWeights?application_version=5.7 -->
...
| Category | Groom |
| Type | [FSplineToLinearSkinWeightsDataflowNode](/documentation/en-us/unreal-engine/API/Plugins/HairStrandsDataflow/FSplineToLinearSkinWeightsDatafl-) |
...
| SplineParamKey | Spline skinning parameter key | [FCollectionAttributeKey](/documentation/en-us/unreal-engine/API/Plugins/DataflowEnginePlugin/FCollectionAttributeKey) | (Attribute="",Group="") |
| SplineBonesKey | Spline bones key. Used for storing root and end spline bone for each vertex. | [FCollectionAttributeKey](/documentation/en-us/unreal-engine/API/Plugins/DataflowEnginePlugin/FCollectionAttributeKey) | (Attribute="",Group="") |
...
* [Description](/documentation/en-us/unreal-engine/node-reference/Dataflow/SplineToLinearSkinWeights?application_version=5.7#description)
* [Information](/documentation/en-us/unreal-engine/node-reference/Dataflow/SplineToLinearSkinWeights?application_version=5.7#information)
* [Inputs](/documentation/en-us/unreal-engine/node-reference/Dataflow/SplineToLinearSkinWeights?application_version=5.7#inputs)
* [Outputs](/documentation/en-us/unreal-engine/node-reference/Dataflow/SplineToLinearSkinWeights?application_version=5.7#outputs)
