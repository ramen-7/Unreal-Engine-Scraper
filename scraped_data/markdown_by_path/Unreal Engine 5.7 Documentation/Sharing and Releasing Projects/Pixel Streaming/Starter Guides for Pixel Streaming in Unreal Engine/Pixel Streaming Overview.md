<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/overview-of-pixel-streaming-in-unreal-engine?application_version=5.7 -->
...
8. Pixel Streaming Overview

# Pixel Streaming Overview

Describes the components that make up the Pixel Streaming system and how they work together at a high level.

![Pixel Streaming Overview](https://dev.epicgames.com/community/api/documentation/image/64e71d1d-c2a6-4c31-9735-74757c9e33e4?resizing_type=fill&width=1920&height=335)
...
* [Benefits](/documentation/en-us/unreal-engine/overview-of-pixel-streaming-in-unreal-engine?application_version=5.7#benefits)
* [Architecture](/documentation/en-us/unreal-engine/overview-of-pixel-streaming-in-unreal-engine?application_version=5.7#architecture)
* [Components](/documentation/en-us/unreal-engine/overview-of-pixel-streaming-in-unreal-engine?application_version=5.7#components)
* [Connection Process](/documentation/en-us/unreal-engine/overview-of-pixel-streaming-in-unreal-engine?application_version=5.7#connectionprocess)
