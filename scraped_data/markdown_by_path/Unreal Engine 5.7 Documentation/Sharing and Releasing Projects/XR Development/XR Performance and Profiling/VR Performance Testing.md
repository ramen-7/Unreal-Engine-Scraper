<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/vr-performance-testing-in-unreal-engine?application_version=5.7 -->
...
Overview of the key principles for performance and profiling of Unreal Engine virtual reality projects.

![VR Performance Testing](https://dev.epicgames.com/community/api/documentation/image/547c2404-9214-40d6-87f6-ce6bcc7498fb?resizing_type=fill&width=1920&height=335)
...
* [Getting General Stats](/documentation/en-us/unreal-engine/vr-performance-testing-in-unreal-engine?application_version=5.7#gettinggeneralstats)
* [Real-Time GPU Profiler](/documentation/en-us/unreal-engine/vr-performance-testing-in-unreal-engine?application_version=5.7#real-timegpuprofiler)
