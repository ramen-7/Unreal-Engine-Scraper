<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/installing-and-setting-up-a-project?application_version=5.7 -->
...
8. Installing Unreal Engine and Setting Up a Project
...
* [![How to Animate with Sequencer](https://dev.epicgames.com/community/api/documentation/image/44a7d9f9-5328-48cd-a00d-3ea3bd4d8e5c?resizing_type=fit&width=640&height=640)
  ...
  How to setup a scene with a level sequence and animate a control rigged character.](https://dev.epicgames.com/documentation/en-us/unreal-engine/how-to-animate-with-sequencer)
...
* [Downloading and Installing Unreal Engine](/documentation/en-us/unreal-engine/installing-and-setting-up-a-project?application_version=5.7#downloadingandinstallingunrealengine)
* [Creating a Project](/documentation/en-us/unreal-engine/installing-and-setting-up-a-project?application_version=5.7#creatingaproject)
* [Download the Control Rig Samples Pack](/documentation/en-us/unreal-engine/installing-and-setting-up-a-project?application_version=5.7#downloadthecontrolrigsamplespack)
* [Additional Notes for Projects](/documentation/en-us/unreal-engine/installing-and-setting-up-a-project?application_version=5.7#additionalnotesforprojects)
* [Fab Marketplace and Unreal Engine](/documentation/en-us/unreal-engine/installing-and-setting-up-a-project?application_version=5.7#fabmarketplaceandunrealengine)
* [Source Control](/documentation/en-us/unreal-engine/installing-and-setting-up-a-project?application_version=5.7#sourcecontrol)
* [Next Step](/documentation/en-us/unreal-engine/installing-and-setting-up-a-project?application_version=5.7#nextstep)
