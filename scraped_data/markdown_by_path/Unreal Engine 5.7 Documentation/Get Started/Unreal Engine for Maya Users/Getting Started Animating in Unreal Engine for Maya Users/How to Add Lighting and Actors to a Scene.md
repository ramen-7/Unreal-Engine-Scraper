<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/how-to-add-lighting-and-effects-to-a-scene?application_version=5.7 -->
...
8. How to Add Lighting and Actors to a Scene
...
Add actors to the Sequencer timeline.
...
Using the Directional Light's hotkey to make adjustments to its rotation and location in the sky for the shot.
...
* **Soft Area Shadows:**
  ...
  + On Spot and Point Lights, use the Source Radius to change how hard or soft shadows are from contact locations.
    ...
    Adjusting a light's radius size.
...
Adjusting properties of fog and its color.
...
Adding a Cine Camera actor to the scene and focusing it on the animated box prop.
...
* You can select it in the **Outliner** and drag and drop it into the **Sequencer Animation Outliner**.
  ...
  Drag and drop an actor onto the Sequencer Animation Outliner.
...
4. When you've done this, press the **Add Keyframe** button next to **Transform** to add a key for it.
   ...
   Move the playhead, pilot the camera to a new location, and record its transform with a new keyframe.
...
Placing a Post Process Volume and changing some of its settings.
...
Working in a real-time scene with your animations.
...
* [![How to use the Movie Render Pipeline for Final Images and Video](https://dev.epicgames.com/community/api/documentation/image/51df4677-b536-488f-b350-53dad0c9e320?resizing_type=fit&width=640&height=640)
  ...
  Learn about Unreal Engine's Movie Render Pipeline and how to use it to render out images and video.](https://dev.epicgames.com/documentation/en-us/unreal-engine/how-to-render-out-final-images-and-video)
...
* [Starter Content](/documentation/en-us/unreal-engine/how-to-add-lighting-and-effects-to-a-scene?application_version=5.7#startercontent)
* [Adding Lighting and Other Components to the Scene](/documentation/en-us/unreal-engine/how-to-add-lighting-and-effects-to-a-scene?application_version=5.7#addinglightingandothercomponentstothescene)
* [Making Changes to Lighting Components](/documentation/en-us/unreal-engine/how-to-add-lighting-and-effects-to-a-scene?application_version=5.7#makingchangestolightingcomponents)
* [Outliner and Details Panel](/documentation/en-us/unreal-engine/how-to-add-lighting-and-effects-to-a-scene?application_version=5.7#outlineranddetailspanel)
* [Editing Actor Properties](/documentation/en-us/unreal-engine/how-to-add-lighting-and-effects-to-a-scene?application_version=5.7#editingactorproperties)
* [Adding a Camera to the Scene](/documentation/en-us/unreal-engine/how-to-add-lighting-and-effects-to-a-scene?application_version=5.7#addingacameratothescene)
* [Using Post Process in Your Scene](/documentation/en-us/unreal-engine/how-to-add-lighting-and-effects-to-a-scene?application_version=5.7#usingpostprocessinyourscene)
* [Making Changes in a Real-Time Editor](/documentation/en-us/unreal-engine/how-to-add-lighting-and-effects-to-a-scene?application_version=5.7#makingchangesinareal-timeeditor)
* [Next Step](/documentation/en-us/unreal-engine/how-to-add-lighting-and-effects-to-a-scene?application_version=5.7#nextstep)
