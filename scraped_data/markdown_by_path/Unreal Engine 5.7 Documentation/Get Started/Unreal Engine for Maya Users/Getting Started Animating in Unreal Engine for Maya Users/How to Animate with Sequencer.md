<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/how-to-animate-with-sequencer?application_version=5.7 -->
...
8. How to Animate with Sequencer
...
3. In the **Content Browser**, navigate to the **ControlRig > Props > CardBox** folder, and drag the asset named **CR\_Cardbox** into the scene.
   ...
   Add Control Rigged prop to the scene.
...
Demonstration of different controllers of a Control Rig.
...
Adjusting the control points of a control rig.
...
Using the Proxy controller of the Control Rig to move the character.
...
Setting the initial pose of the Control Rig.
...
Applying brute force animation methods of just moving and keying the object.
...
Using Unreal Engine's temporary pivot tool to move and key changes.
...
Using a proxy controller set up on a Control Rig to handle movement.
...
Result of setting the rocking back and forth motion for the control rigged prop.
...
The result of adding the jumping keyframes to Sequencer.
...
The full keyframed animation in Sequencer with the rocking back and forth and jumping.
...
2. With this pose selected, we’ll select the top red square at the top of the box. Using the Move gizmo, drag the Z axis (blue) direction up, stretching the mesh.
   ...
   Use the Move gizmo and drag some controllers to apply squash and stretch to the prop.
...
Using the Tween Tools in Curve Editor to fine-tune and add animated keyframes.
...
* [![How to Add Lighting and Actors to a Scene](https://dev.epicgames.com/community/api/documentation/image/76dd6b45-1611-42af-a915-c4704354d61c?resizing_type=fit&width=640&height=640)
  ...
  How to add lights and other actors to a scene while working in real-time.](https://dev.epicgames.com/documentation/en-us/unreal-engine/how-to-add-lighting-and-effects-to-a-scene)
...
* [Recommended Reading](/documentation/en-us/unreal-engine/how-to-animate-with-sequencer?application_version=5.7#recommendedreading)
* [Create a New Level](/documentation/en-us/unreal-engine/how-to-animate-with-sequencer?application_version=5.7#createanewlevel)
* [Preparing the Scene](/documentation/en-us/unreal-engine/how-to-animate-with-sequencer?application_version=5.7#preparingthescene)
* [Using Sequencer to Animate with Control Rig](/documentation/en-us/unreal-engine/how-to-animate-with-sequencer?application_version=5.7#usingsequencertoanimatewithcontrolrig)
* [Level Editor Animation Mode](/documentation/en-us/unreal-engine/how-to-animate-with-sequencer?application_version=5.7#leveleditoranimationmode)
* [Control Rig Control Points](/documentation/en-us/unreal-engine/how-to-animate-with-sequencer?application_version=5.7#controlrigcontrolpoints)
* [Setting the Control Rig Pose](/documentation/en-us/unreal-engine/how-to-animate-with-sequencer?application_version=5.7#settingthecontrolrigpose)
* [Animating and Setting Keyframes in Sequencer](/documentation/en-us/unreal-engine/how-to-animate-with-sequencer?application_version=5.7#animatingandsettingkeyframesinsequencer)
* [Setting the Initial Key Frames for the Animation](/documentation/en-us/unreal-engine/how-to-animate-with-sequencer?application_version=5.7#settingtheinitialkeyframesfortheanimation)
* [Animating Squash and Stretch](/documentation/en-us/unreal-engine/how-to-animate-with-sequencer?application_version=5.7#animatingsquashandstretch)
* [Making Fine Adjustments to Keyframes](/documentation/en-us/unreal-engine/how-to-animate-with-sequencer?application_version=5.7#makingfineadjustmentstokeyframes)
* [Next Step](/documentation/en-us/unreal-engine/how-to-animate-with-sequencer?application_version=5.7#nextstep)
