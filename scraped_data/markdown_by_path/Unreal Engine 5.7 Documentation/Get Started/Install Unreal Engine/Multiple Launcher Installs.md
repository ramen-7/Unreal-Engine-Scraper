<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/multiple-launcher-unreal-engine-installs?application_version=5.7 -->
...
7. Multiple Launcher Installs

# Multiple Launcher Installs

Overview of how to enable the Launcher's PCB Mode, and if needed, how to add a Windows Registry Install Path Override.

![Multiple Launcher Installs](https://dev.epicgames.com/community/api/documentation/image/779d6b99-d654-4e6d-9e06-ac265f20f8ad?resizing_type=fill&width=1920&height=335)
...
* [Launcher PCB Mode](/documentation/en-us/unreal-engine/multiple-launcher-unreal-engine-installs?application_version=5.7#launcherpcbmode)
* [Enabling Launcher PCB Mode](/documentation/en-us/unreal-engine/multiple-launcher-unreal-engine-installs?application_version=5.7#enablinglauncherpcbmode)
* [Disabling Launcher PCB Mode](/documentation/en-us/unreal-engine/multiple-launcher-unreal-engine-installs?application_version=5.7#disablinglauncherpcbmode)
* [Windows Registry Install Path Override](/documentation/en-us/unreal-engine/multiple-launcher-unreal-engine-installs?application_version=5.7#windowsregistryinstallpathoverride)
* [Adding a Registry Install Path Override](/documentation/en-us/unreal-engine/multiple-launcher-unreal-engine-installs?application_version=5.7#addingaregistryinstallpathoverride)
