<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/emitter-spawn-group-reference-for-niagara-effects-in-unreal-engine?application_version=5.7 -->
...
8. Emitter Spawn Group

# Emitter Spawn Group

This document provides reference information for modules in the Emitter Spawn group.

![Emitter Spawn Group](https://dev.epicgames.com/community/api/documentation/image/18e7d776-66bb-4c61-b609-c92662d47ff7?resizing_type=fill&width=1920&height=335)
...
* [Location Module](/documentation/en-us/unreal-engine/emitter-spawn-group-reference-for-niagara-effects-in-unreal-engine?application_version=5.7#locationmodule)
* [MAX Scripts Module](/documentation/en-us/unreal-engine/emitter-spawn-group-reference-for-niagara-effects-in-unreal-engine?application_version=5.7#maxscriptsmodule)
* [Spawning Modules](/documentation/en-us/unreal-engine/emitter-spawn-group-reference-for-niagara-effects-in-unreal-engine?application_version=5.7#spawningmodules)
* [New Scratch Pad Module](/documentation/en-us/unreal-engine/emitter-spawn-group-reference-for-niagara-effects-in-unreal-engine?application_version=5.7#newscratchpadmodule)
* [Set New or Existing Value Directly](/documentation/en-us/unreal-engine/emitter-spawn-group-reference-for-niagara-effects-in-unreal-engine?application_version=5.7#setneworexistingvaluedirectly)
* [Add Parameter](/documentation/en-us/unreal-engine/emitter-spawn-group-reference-for-niagara-effects-in-unreal-engine?application_version=5.7#addparameter)
* [Create New Parameter](/documentation/en-us/unreal-engine/emitter-spawn-group-reference-for-niagara-effects-in-unreal-engine?application_version=5.7#createnewparameter)
