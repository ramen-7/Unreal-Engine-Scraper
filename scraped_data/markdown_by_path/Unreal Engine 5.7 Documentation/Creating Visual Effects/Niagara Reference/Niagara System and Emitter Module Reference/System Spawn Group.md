<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/system-spawn-group-reference-for-niagara-effects-in-unreal-engine?application_version=5.7 -->
...
8. System Spawn Group

# System Spawn Group

This document provides reference information for modules in the System Spawn group.

![System Spawn Group](https://dev.epicgames.com/community/api/documentation/image/17698b3b-f8d3-4c10-8b91-181a16094ffb?resizing_type=fill&width=1920&height=335)
...
* [Spawning Modules](/documentation/en-us/unreal-engine/system-spawn-group-reference-for-niagara-effects-in-unreal-engine?application_version=5.7#spawningmodules)
* [New Scratch Pad Module](/documentation/en-us/unreal-engine/system-spawn-group-reference-for-niagara-effects-in-unreal-engine?application_version=5.7#newscratchpadmodule)
* [Set New or Existing Value Directly](/documentation/en-us/unreal-engine/system-spawn-group-reference-for-niagara-effects-in-unreal-engine?application_version=5.7#setneworexistingvaluedirectly)
* [Add Parameter](/documentation/en-us/unreal-engine/system-spawn-group-reference-for-niagara-effects-in-unreal-engine?application_version=5.7#addparameter)
* [Create New Parameter](/documentation/en-us/unreal-engine/system-spawn-group-reference-for-niagara-effects-in-unreal-engine?application_version=5.7#createnewparameter)
