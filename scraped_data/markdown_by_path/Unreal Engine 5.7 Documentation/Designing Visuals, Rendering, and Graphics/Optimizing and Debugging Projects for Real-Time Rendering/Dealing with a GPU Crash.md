<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/dealing-with-a-gpu-crash-when-using-unreal-engine?application_version=5.7 -->
...
7. Dealing with a GPU Crash

# Dealing with a GPU Crash

An overview of investigating, resolving, and reporting GPU Crashes in Unreal Engine.

![Dealing with a GPU Crash](https://dev.epicgames.com/community/api/documentation/image/6fb92643-41df-457c-97ef-82cdfe0c715b?resizing_type=fill&width=1920&height=335)
...
3. Navigate to the **GraphicsDrivers** section of the navigation on the left side of the Registry Edit tool. The location for this is `Computer\HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\GraphicsDrivers`.
   ...
   [![undefined](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/b11e9ba2-2b15-497a-aab5-741eab0bf2d1/reg-edit-graphics-drivers.png)](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/b11e9ba2-2b15-497a-aab5-741eab0bf2d1/reg-edit-graphics-drivers.png)
...
8. Your registry should now include both `TdrDelay` and `TdrDdiDelay`.
   ...
   [![undefined](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/d2be0245-fd09-48c7-862e-52001564de7e/graphics-drivers-final.png)](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/d2be0245-fd09-48c7-862e-52001564de7e/graphics-drivers-final.png)
...
* [What is a GPU Crash?](/documentation/en-us/unreal-engine/dealing-with-a-gpu-crash-when-using-unreal-engine?application_version=5.7#whatisagpucrash?)
* [Recognizing a GPU Crash](/documentation/en-us/unreal-engine/dealing-with-a-gpu-crash-when-using-unreal-engine?application_version=5.7#recognizingagpucrash)
* [What are the Possible Causes of a GPU Crash?](/documentation/en-us/unreal-engine/dealing-with-a-gpu-crash-when-using-unreal-engine?application_version=5.7#whatarethepossiblecausesofagpucrash?)
* [How Do I Report a GPU Crash to Epic Games?](/documentation/en-us/unreal-engine/dealing-with-a-gpu-crash-when-using-unreal-engine?application_version=5.7#howdoireportagpucrashtoepicgames?)
* [Debugging a GPU Crash Workflow](/documentation/en-us/unreal-engine/dealing-with-a-gpu-crash-when-using-unreal-engine?application_version=5.7#debuggingagpucrashworkflow)
* [Resolving GPU Out-Of-Memory Issues](/documentation/en-us/unreal-engine/dealing-with-a-gpu-crash-when-using-unreal-engine?application_version=5.7#resolvinggpuout-of-memoryissues)
* [Understanding and Resolving GPU Timeouts](/documentation/en-us/unreal-engine/dealing-with-a-gpu-crash-when-using-unreal-engine?application_version=5.7#understandingandresolvinggputimeouts)
* [TDR Events with Hardware Ray Tracing](/documentation/en-us/unreal-engine/dealing-with-a-gpu-crash-when-using-unreal-engine?application_version=5.7#tdreventswithhardwareraytracing)
* [How to Resolve TDR Events](/documentation/en-us/unreal-engine/dealing-with-a-gpu-crash-when-using-unreal-engine?application_version=5.7#howtoresolvetdrevents)
