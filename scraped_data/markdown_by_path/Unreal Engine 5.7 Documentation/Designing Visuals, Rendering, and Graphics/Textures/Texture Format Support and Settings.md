<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/texture-format-support-and-settings-in-unreal-engine?application_version=5.7 -->
...
7. Texture Format Support and Settings

# Texture Format Support and Settings

Reference for supported texture formats and file types and their configuration.

![Texture Format Support and Settings](https://dev.epicgames.com/community/api/documentation/image/87134dcb-c13b-4b9a-9bcd-2d04b53af071?resizing_type=fill&width=1920&height=335)
...
[![TextureLOD_8k.png](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/da1dde54-ed5e-4250-94ae-5d09d36242ac/texturelod_8k.png)](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/da1dde54-ed5e-4250-94ae-5d09d36242ac/texturelod_8k.png)
...
* [Texture Resolution](/documentation/en-us/unreal-engine/texture-format-support-and-settings-in-unreal-engine?application_version=5.7#textureresolution)
* [Engine Texture Resolution Limit](/documentation/en-us/unreal-engine/texture-format-support-and-settings-in-unreal-engine?application_version=5.7#enginetextureresolutionlimit)
* [Compressed Texture Memory Requirements](/documentation/en-us/unreal-engine/texture-format-support-and-settings-in-unreal-engine?application_version=5.7#compressedtexturememoryrequirements)
* [Engine Config TextureGroup Properties](/documentation/en-us/unreal-engine/texture-format-support-and-settings-in-unreal-engine?application_version=5.7#engineconfigtexturegroupproperties)
* [PC AppCompat Buckets](/documentation/en-us/unreal-engine/texture-format-support-and-settings-in-unreal-engine?application_version=5.7#pcappcompatbuckets)
* [TEXTUREGROUP Properties](/documentation/en-us/unreal-engine/texture-format-support-and-settings-in-unreal-engine?application_version=5.7#texturegroupproperties)
* [Filtering](/documentation/en-us/unreal-engine/texture-format-support-and-settings-in-unreal-engine?application_version=5.7#filtering)
* [TextureGroup, LODGroup and LODBias](/documentation/en-us/unreal-engine/texture-format-support-and-settings-in-unreal-engine?application_version=5.7#texturegroup,lodgroupandlodbias)
* [Texture Properties](/documentation/en-us/unreal-engine/texture-format-support-and-settings-in-unreal-engine?application_version=5.7#textureproperties)
