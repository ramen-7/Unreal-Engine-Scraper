<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/graphics-programming-overview-for-unreal-engine?application_version=5.7 -->
...
7. Graphics Programming Overview

# Graphics Programming Overview

Information for graphics programmers working with the rendering systems and writing shaders.

![Graphics Programming Overview](https://dev.epicgames.com/community/api/documentation/image/c4c5ad73-d49f-4dfe-a001-ca2a4ad02a39?resizing_type=fill&width=1920&height=335)
...
* [Getting Started](/documentation/en-us/unreal-engine/graphics-programming-overview-for-unreal-engine?application_version=5.7#gettingstarted)
* [Modules](/documentation/en-us/unreal-engine/graphics-programming-overview-for-unreal-engine?application_version=5.7#modules)
* [Scene representation](/documentation/en-us/unreal-engine/graphics-programming-overview-for-unreal-engine?application_version=5.7#scenerepresentation)
* [Primary scene classes](/documentation/en-us/unreal-engine/graphics-programming-overview-for-unreal-engine?application_version=5.7#primarysceneclasses)
* [Material classes](/documentation/en-us/unreal-engine/graphics-programming-overview-for-unreal-engine?application_version=5.7#materialclasses)
* [Primitive components and proxies](/documentation/en-us/unreal-engine/graphics-programming-overview-for-unreal-engine?application_version=5.7#primitivecomponentsandproxies)
* [FPrimitiveSceneProxy and FPrimitiveSceneInfo](/documentation/en-us/unreal-engine/graphics-programming-overview-for-unreal-engine?application_version=5.7#fprimitivesceneproxyandfprimitivesceneinfo)
* [Important FPrimitiveSceneProxy methods](/documentation/en-us/unreal-engine/graphics-programming-overview-for-unreal-engine?application_version=5.7#importantfprimitivesceneproxymethods)
* [Scene rendering order](/documentation/en-us/unreal-engine/graphics-programming-overview-for-unreal-engine?application_version=5.7#scenerenderingorder)
* [Relevance](/documentation/en-us/unreal-engine/graphics-programming-overview-for-unreal-engine?application_version=5.7#relevance)
* [Drawing Policies](/documentation/en-us/unreal-engine/graphics-programming-overview-for-unreal-engine?application_version=5.7#drawingpolicies)
* [Drawing Policy methods](/documentation/en-us/unreal-engine/graphics-programming-overview-for-unreal-engine?application_version=5.7#drawingpolicymethods)
* [Rendering paths](/documentation/en-us/unreal-engine/graphics-programming-overview-for-unreal-engine?application_version=5.7#renderingpaths)
* [Dynamic rendering path](/documentation/en-us/unreal-engine/graphics-programming-overview-for-unreal-engine?application_version=5.7#dynamicrenderingpath)
* [Static rendering path](/documentation/en-us/unreal-engine/graphics-programming-overview-for-unreal-engine?application_version=5.7#staticrenderingpath)
* [High level Rendering order](/documentation/en-us/unreal-engine/graphics-programming-overview-for-unreal-engine?application_version=5.7#highlevelrenderingorder)
* [Render Hardware Interface (RHI)](/documentation/en-us/unreal-engine/graphics-programming-overview-for-unreal-engine?application_version=5.7#renderhardwareinterface(rhi))
* [Rendering state grouping](/documentation/en-us/unreal-engine/graphics-programming-overview-for-unreal-engine?application_version=5.7#renderingstategrouping)
* [Rendering state defaults](/documentation/en-us/unreal-engine/graphics-programming-overview-for-unreal-engine?application_version=5.7#renderingstatedefaults)
