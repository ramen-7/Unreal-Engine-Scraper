<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/threaded-rendering-in-unreal-engine?application_version=5.7 -->
...
7. Threaded Rendering

# Threaded Rendering

Information for graphics programmers working with the threaded renderer.

![Threaded Rendering](https://dev.epicgames.com/community/api/documentation/image/9387256e-641f-49cf-82bd-ccc687a775c1?resizing_type=fill&width=1920&height=335)
...
* [Rendering thread](/documentation/en-us/unreal-engine/threaded-rendering-in-unreal-engine?application_version=5.7#renderingthread)
* [Development approach](/documentation/en-us/unreal-engine/threaded-rendering-in-unreal-engine?application_version=5.7#developmentapproach)
* [Thread specific data structures](/documentation/en-us/unreal-engine/threaded-rendering-in-unreal-engine?application_version=5.7#threadspecificdatastructures)
* [Performance considerations](/documentation/en-us/unreal-engine/threaded-rendering-in-unreal-engine?application_version=5.7#performanceconsiderations)
* [Inter-thread communication](/documentation/en-us/unreal-engine/threaded-rendering-in-unreal-engine?application_version=5.7#inter-threadcommunication)
* [Asynchronous](/documentation/en-us/unreal-engine/threaded-rendering-in-unreal-engine?application_version=5.7#asynchronous)
* [Blocking](/documentation/en-us/unreal-engine/threaded-rendering-in-unreal-engine?application_version=5.7#blocking)
* [Rendering resources](/documentation/en-us/unreal-engine/threaded-rendering-in-unreal-engine?application_version=5.7#renderingresources)
* [UObjects and Garbage Collection](/documentation/en-us/unreal-engine/threaded-rendering-in-unreal-engine?application_version=5.7#uobjectsandgarbagecollection)
* [Game thread FRenderResource handling](/documentation/en-us/unreal-engine/threaded-rendering-in-unreal-engine?application_version=5.7#gamethreadfrenderresourcehandling)
* [Static resources](/documentation/en-us/unreal-engine/threaded-rendering-in-unreal-engine?application_version=5.7#staticresources)
* [Dynamic resources](/documentation/en-us/unreal-engine/threaded-rendering-in-unreal-engine?application_version=5.7#dynamicresources)
* [Updating state vs Traversing the scene for rendering](/documentation/en-us/unreal-engine/threaded-rendering-in-unreal-engine?application_version=5.7#updatingstatevstraversingthesceneforrendering)
