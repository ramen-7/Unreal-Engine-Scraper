<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/mesh-drawing-pipeline-in-unreal-engine?application_version=5.7 -->
...
7. Mesh Drawing Pipeline

# Mesh Drawing Pipeline

Guide to adding custom mesh passes and understanding Unreal Engine's mesh drawing performance characteristics.

![Mesh Drawing Pipeline](https://dev.epicgames.com/community/api/documentation/image/f2a509c5-44e7-4b6d-927b-b2b08c58dfb9?resizing_type=fill&width=1920&height=335)
...
* [Cached and Dynamic Mesh Batches](/documentation/en-us/unreal-engine/mesh-drawing-pipeline-in-unreal-engine?application_version=5.7#cachedanddynamicmeshbatches)
* [FMeshPassProcessor](/documentation/en-us/unreal-engine/mesh-drawing-pipeline-in-unreal-engine?application_version=5.7#fmeshpassprocessor)
* [Shader Bindings](/documentation/en-us/unreal-engine/mesh-drawing-pipeline-in-unreal-engine?application_version=5.7#shaderbindings)
* [FMeshDrawCommand Performance Hazards](/documentation/en-us/unreal-engine/mesh-drawing-pipeline-in-unreal-engine?application_version=5.7#fmeshdrawcommandperformancehazards)
* [Pass Types](/documentation/en-us/unreal-engine/mesh-drawing-pipeline-in-unreal-engine?application_version=5.7#passtypes)
* [FParallelMeshDrawCommandPass](/documentation/en-us/unreal-engine/mesh-drawing-pipeline-in-unreal-engine?application_version=5.7#fparallelmeshdrawcommandpass)
* [DrawDynamicMeshPass](/documentation/en-us/unreal-engine/mesh-drawing-pipeline-in-unreal-engine?application_version=5.7#drawdynamicmeshpass)
* [Cached Mesh Draw Commands](/documentation/en-us/unreal-engine/mesh-drawing-pipeline-in-unreal-engine?application_version=5.7#cachedmeshdrawcommands)
* [Cache Invalidation](/documentation/en-us/unreal-engine/mesh-drawing-pipeline-in-unreal-engine?application_version=5.7#cacheinvalidation)
* [Resource Lifetime Management](/documentation/en-us/unreal-engine/mesh-drawing-pipeline-in-unreal-engine?application_version=5.7#resourcelifetimemanagement)
* [Draw Call Merging](/documentation/en-us/unreal-engine/mesh-drawing-pipeline-in-unreal-engine?application_version=5.7#drawcallmerging)
* [Dynamic Instancing](/documentation/en-us/unreal-engine/mesh-drawing-pipeline-in-unreal-engine?application_version=5.7#dynamicinstancing)
* [GPU Scene](/documentation/en-us/unreal-engine/mesh-drawing-pipeline-in-unreal-engine?application_version=5.7#gpuscene)
* [Instancing Efficiency](/documentation/en-us/unreal-engine/mesh-drawing-pipeline-in-unreal-engine?application_version=5.7#instancingefficiency)
* [Mesh Drawing Parallelism](/documentation/en-us/unreal-engine/mesh-drawing-pipeline-in-unreal-engine?application_version=5.7#meshdrawingparallelism)
* [Console Variables](/documentation/en-us/unreal-engine/mesh-drawing-pipeline-in-unreal-engine?application_version=5.7#consolevariables)
