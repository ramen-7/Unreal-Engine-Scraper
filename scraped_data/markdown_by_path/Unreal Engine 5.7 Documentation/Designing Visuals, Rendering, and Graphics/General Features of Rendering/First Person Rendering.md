<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/first-person-rendering?application_version=5.7 -->
...
[![](https://dev.epicgames.com/community/api/documentation/image/edb2d5d4-6de7-4d59-8a02-89418017bdf1?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/edb2d5d4-6de7-4d59-8a02-89418017bdf1?resizing_type=fit)
...
![First Person Self-Shadow: Disabled](https://dev.epicgames.com/community/api/documentation/image/9121ea25-b546-4b88-8056-7f5d1b2d669d?resizing_type=fit&width=1920&height=1080)

![First Person Self-Shadow: Enabled](https://dev.epicgames.com/community/api/documentation/image/974f5960-a47b-4a39-acdb-a05b35b10369?resizing_type=fit&width=1920&height=1080)
...
2. In the Details panel, click **Add** and select a desired **Primitive** component (Static Mesh, Skeletal Mesh, Particle System, and so on) to add to this actor.
   ...
   [![Add a primitive component.](https://dev.epicgames.com/community/api/documentation/image/7afba4fe-5c40-4f8a-9674-5e26bd8385ef?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/7afba4fe-5c40-4f8a-9674-5e26bd8385ef?resizing_type=fit)
   ...
   2. With the Primitive component selected, use the **Details** panel to locate the property **First Person Primitive Type** under **Rendering > Advanced** properties. Use the dropdown selection to set it to **First Person**.
      ...
      [![Set the First Person Primitive Type to First Person.](https://dev.epicgames.com/community/api/documentation/image/c51abd72-6d18-4e63-bcad-d2b026ecdad4?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/c51abd72-6d18-4e63-bcad-d2b026ecdad4?resizing_type=fit)
   3. In the Details panel, click on the **Camera Component** and check the boxes next to **Enable First Person Field Of View** and **Enable First Person Scale** under **Camera Options** properties.
      ...
      [![Enable First Person Field of View and First Person Scale on the Camera Component.](https://dev.epicgames.com/community/api/documentation/image/2eef1abc-f602-4ed1-a915-33d14d86476c?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/2eef1abc-f602-4ed1-a915-33d14d86476c?resizing_type=fit)
...
[![First Person Camera view result.](https://dev.epicgames.com/community/api/documentation/image/7005d7cf-5924-4d41-9fe9-a5770f10f158?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/7005d7cf-5924-4d41-9fe9-a5770f10f158?resizing_type=fit)
...
[![First Person field of view and scale camera settings.](https://dev.epicgames.com/community/api/documentation/image/e50b5ede-b6b6-4542-914d-d04550b15a35?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/e50b5ede-b6b6-4542-914d-d04550b15a35?resizing_type=fit)
...
First Person Field of View Setting
...
First Person Field of View and Scale Together
...
[![First Person components and their world space representations.](https://dev.epicgames.com/community/api/documentation/image/027d3b8f-ae26-4294-bc95-2f0455ed959c?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/027d3b8f-ae26-4294-bc95-2f0455ed959c?resizing_type=fit)
...
|  |  |
| --- | --- |
| [First person mesh only.](https://dev.epicgames.com/community/api/documentation/image/40eb19b4-2aea-46ed-81cd-0857c7abf108?resizing_type=fit) | [First person mesh with world representation mesh casting shadows.](https://dev.epicgames.com/community/api/documentation/image/42ec43a2-b7db-4b2b-8a66-1d99ff8b4f3f?resizing_type=fit) |
...
First Person and World Representation Primitive Type Settings
...
[![First Person Output material expression.](https://dev.epicgames.com/community/api/documentation/image/f5fe078d-77e2-416d-9f88-de1254c24406?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/f5fe078d-77e2-416d-9f88-de1254c24406?resizing_type=fit)
...
[![First Person Set Material Attributes material expression.](https://dev.epicgames.com/community/api/documentation/image/8e01c15b-eb42-457e-8f31-366f4731517c?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/8e01c15b-eb42-457e-8f31-366f4731517c?resizing_type=fit)
...
[![First Person Transform Position material expression.](https://dev.epicgames.com/community/api/documentation/image/368f4085-01af-48be-ad63-6c7f8d3e519f?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/368f4085-01af-48be-ad63-6c7f8d3e519f?resizing_type=fit)

First Person Transform Position material expression.

With the node selected, use the **Details** panel to set the following:

[![First Person Transform Position settings.](https://dev.epicgames.com/community/api/documentation/image/eddee3e3-4e98-4b03-a997-073c6d7e9d7e?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/eddee3e3-4e98-4b03-a997-073c6d7e9d7e?resizing_type=fit)
...
[![Is First Person material expression.](https://dev.epicgames.com/community/api/documentation/image/3fcafa40-85c2-4445-8d0a-6e0cc7eb316d?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/3fcafa40-85c2-4445-8d0a-6e0cc7eb316d?resizing_type=fit)
...
[![Example using the Is First Person material expression.](https://dev.epicgames.com/community/api/documentation/image/de550a4b-5277-4439-9b55-2e526bcf2dec?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/de550a4b-5277-4439-9b55-2e526bcf2dec?resizing_type=fit)
...
* **First Person Field of View** returns the horizontal and vertical first person field of view angles in radians.
  ...
  [![First Person Field of View material expression](https://dev.epicgames.com/community/api/documentation/image/6581e5eb-a3bc-48d2-b352-0372fb262cd2?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/6581e5eb-a3bc-48d2-b352-0372fb262cd2?resizing_type=fit)
* First Person Scale returns the scaling factor applied to first person primitives to keep them from intersecting with the scene.
  ...
  [![First Person Scale material expression](https://dev.epicgames.com/community/api/documentation/image/71064181-8ae4-4e9b-9bec-85cf3513733b?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/71064181-8ae4-4e9b-9bec-85cf3513733b?resizing_type=fit)

With the node selected, use the **Details** panel to set the **View Property** dropdown list to the view you want to query.

[![First Person View Property Selection.](https://dev.epicgames.com/community/api/documentation/image/816b3c2c-5958-4cc8-9650-3b2fb99912b4?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/816b3c2c-5958-4cc8-9650-3b2fb99912b4?resizing_type=fit)
...
[![Scene Texture: Is First Person material expression.](https://dev.epicgames.com/community/api/documentation/image/3559ca1c-9746-478b-a265-cc818e9e3b41?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/3559ca1c-9746-478b-a265-cc818e9e3b41?resizing_type=fit)
...
[![IsFirstPerson Scene Texture ID](https://dev.epicgames.com/community/api/documentation/image/7ca787d8-0f0b-425e-a70b-4770451deed7?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/7ca787d8-0f0b-425e-a70b-4770451deed7?resizing_type=fit)

IsFirstPerson Scene Texture ID

For additional info, see the [Limitations](https://dev.epicgames.com/documentation/en-us/unreal-engine/first-person-rendering#limitations-and-notes) section below.
...
* [First Person Rendering Implementation](/documentation/en-us/unreal-engine/first-person-rendering?application_version=5.7#firstpersonrenderingimplementation)
* [First Person Primitives Settings](/documentation/en-us/unreal-engine/first-person-rendering?application_version=5.7#firstpersonprimitivessettings)
* [First Person Shadows](/documentation/en-us/unreal-engine/first-person-rendering?application_version=5.7#firstpersonshadows)
* [First Person Self-Shadow](/documentation/en-us/unreal-engine/first-person-rendering?application_version=5.7#firstpersonself-shadow)
* [First Person World Space Representation Shadows](/documentation/en-us/unreal-engine/first-person-rendering?application_version=5.7#firstpersonworldspacerepresentationshadows)
* [Setting Up A First Person Camera](/documentation/en-us/unreal-engine/first-person-rendering?application_version=5.7#settingupafirstpersoncamera)
* [Basic Setup of a First Person Camera](/documentation/en-us/unreal-engine/first-person-rendering?application_version=5.7#basic-setup-of-a-first-person-camera)
* [Setting up the Camera and First Person Components](/documentation/en-us/unreal-engine/first-person-rendering?application_version=5.7#settingupthecameraandfirstpersoncomponents)
* [Configuring First Person Field of View and Scale Settings](/documentation/en-us/unreal-engine/first-person-rendering?application_version=5.7#configuringfirstpersonfieldofviewandscalesettings)
* [First Person Geometry](/documentation/en-us/unreal-engine/first-person-rendering?application_version=5.7#firstpersongeometry)
* [Set Up of First Person Components and Their World Space Representations](/documentation/en-us/unreal-engine/first-person-rendering?application_version=5.7#setupoffirstpersoncomponentsandtheirworldspacerepresentations)
* [Integration with Materials](/documentation/en-us/unreal-engine/first-person-rendering?application_version=5.7#integration-with-materials)
* [First Person Output Node](/documentation/en-us/unreal-engine/first-person-rendering?application_version=5.7#firstpersonoutputnode)
* [Transform Position Node](/documentation/en-us/unreal-engine/first-person-rendering?application_version=5.7#transformpositionnode)
* [Is First Person Node](/documentation/en-us/unreal-engine/first-person-rendering?application_version=5.7#isfirstpersonnode)
* [View Property Node](/documentation/en-us/unreal-engine/first-person-rendering?application_version=5.7#viewpropertynode)
* [Scene Texture Node](/documentation/en-us/unreal-engine/first-person-rendering?application_version=5.7#scenetexturenode)
* [Limitations and Notes](/documentation/en-us/unreal-engine/first-person-rendering?application_version=5.7#limitations-and-notes)
* [Additional Resources](/documentation/en-us/unreal-engine/first-person-rendering?application_version=5.7#additionalresources)
* [First Person Template](/documentation/en-us/unreal-engine/first-person-rendering?application_version=5.7#firstpersontemplate)
