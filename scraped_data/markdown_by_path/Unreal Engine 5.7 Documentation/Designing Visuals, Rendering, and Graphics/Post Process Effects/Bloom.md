<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/bloom-in-unreal-engine?application_version=5.7 -->
...
![Bloom](https://dev.epicgames.com/community/api/documentation/image/9a7d47a3-5360-4c7a-963a-59973a6c5a4a?resizing_type=fill&width=1920&height=335)
...
* The kernel image should be fully present on the GPU and available at full resolution, otherwise a low resolution version of the kernel may be used and will result in serious
  ...
  |  |  |
  | --- | --- |
  |  | + Mips Gen Setting: **No Mipmaps** + Never Stream: **Enabled** |
...
* When constructing your Dirt Mask Texture, keep the following in mind:
  ...
  [![undefined](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/c3b7a8fb-7ce1-4510-aab1-02b3e1f7daa7/dirtmasktextureexample.png)](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/c3b7a8fb-7ce1-4510-aab1-02b3e1f7daa7/dirtmasktextureexample.png)
...
* [Intensity](/documentation/en-us/unreal-engine/bloom-in-unreal-engine?application_version=5.7#intensity)
* [Threshold](/documentation/en-us/unreal-engine/bloom-in-unreal-engine?application_version=5.7#threshold)
* [Size](/documentation/en-us/unreal-engine/bloom-in-unreal-engine?application_version=5.7#size)
* [Bloom Convolution](/documentation/en-us/unreal-engine/bloom-in-unreal-engine?application_version=5.7#bloomconvolution)
* [Kernel Image Best Practices](/documentation/en-us/unreal-engine/bloom-in-unreal-engine?application_version=5.7#kernelimagebestpractices)
* [Bloom Dirt Mask](/documentation/en-us/unreal-engine/bloom-in-unreal-engine?application_version=5.7#bloomdirtmask)
* [Dirt Mask Image Best Practices](/documentation/en-us/unreal-engine/bloom-in-unreal-engine?application_version=5.7#dirtmaskimagebestpractices)
* [Training Streams](/documentation/en-us/unreal-engine/bloom-in-unreal-engine?application_version=5.7#trainingstreams)
