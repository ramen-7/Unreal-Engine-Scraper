<!-- source: https://dev.epicgames.com/documentation/en-us/unreal-engine/blueprint-best-practices-in-unreal-engine?application_version=5.7 -->
...
![Blueprint Best Practices](https://dev.epicgames.com/community/api/documentation/image/9c9f9f24-2489-446b-8a46-43412c959541?resizing_type=fill&width=1920&height=335)
...
* [Level Blueprints vs. Blueprint Classes](/documentation/en-us/unreal-engine/blueprint-best-practices-in-unreal-engine?application_version=5.7#levelblueprintsvsblueprintclasses)
* [Class Variables vs. Local Variables](/documentation/en-us/unreal-engine/blueprint-best-practices-in-unreal-engine?application_version=5.7#classvariablesvslocalvariables)
* [Functions vs. Macros](/documentation/en-us/unreal-engine/blueprint-best-practices-in-unreal-engine?application_version=5.7#functionsvsmacros)
* [Blueprint Communication Types](/documentation/en-us/unreal-engine/blueprint-best-practices-in-unreal-engine?application_version=5.7#blueprintcommunicationtypes)
* [General Tips](/documentation/en-us/unreal-engine/blueprint-best-practices-in-unreal-engine?application_version=5.7#generaltips)
* [Working in the Blueprint Editor](/documentation/en-us/unreal-engine/blueprint-best-practices-in-unreal-engine?application_version=5.7#workingintheblueprinteditor)
* [Setting Up Your Graph](/documentation/en-us/unreal-engine/blueprint-best-practices-in-unreal-engine?application_version=5.7#settingupyourgraph)
